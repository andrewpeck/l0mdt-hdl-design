...
add wave -noupdate -group hps_tb -expand -group clks_gen /hps_tb/clk
add wave -noupdate -group hps_tb -expand -group clks_gen /hps_tb/clk_axi
add wave -noupdate -group hps_tb -expand -group clks_gen /hps_tb/reset_init_cycles
add wave -noupdate -group hps_tb -expand -group clks_gen /hps_tb/clk_axi_cnt
add wave -noupdate -group hps_tb -expand -group clks_gen /hps_tb/clk_period
add wave -noupdate -group hps_tb -expand -group clks_gen /hps_tb/clk_tdc_time
add wave -noupdate -group hps_tb -expand -group clks_gen /hps_tb/clk_tdc_time_period
add wave -noupdate -group hps_tb -expand -group clks_gen /hps_tb/clk_time
add wave -noupdate -group hps_tb -expand -group clks_gen /hps_tb/clk_time_period
add wave -noupdate -group hps_tb -expand -group clks_gen /hps_tb/tb_curr_tdc_time
add wave -noupdate -group hps_tb -expand -group clks_gen /hps_tb/tb_curr_time
...
add wave -noupdate -group hps_inn_pc /hps_tb/STATION_GEN(0)/HPS/HPS/PC/o_mdt_full_data_v
...
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/clk
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/enable
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/g_PRJ_INFO
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/g_ST_ENABLE
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/i_tar2hps_file_ok
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/i_tar2hps_file_ts
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/i_tar2hps_mdt_event_ai
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/i_ucm2hps_file_ok
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/i_ucm2hps_file_ts
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/i_ucm2hps_slc_event_ai
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/rst
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/tb_curr_tdc_time
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/csv_file_1
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/in_files_ok
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/in_files_ts
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/mdt_event_a
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/mdt_event_au
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/OUT_FILE_1
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/slc_event_a
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/slc_event_au
add wave -noupdate -expand -group hps_int_out -expand -group inn /hps_tb/HPSOUT/ST_GEN(0)/ST_EN/temp_mdt_full_data_av
add wave -noupdate -expand -group hps_int_out -expand -group inn -expand -group th2 -expand /hps_tb/HPSOUT/ST_GEN(0)/ST_EN/TH_GEN(2)/temp_hp2bm_av
add wave -noupdate -expand -group hps_int_out /hps_tb/HPSOUT/hps_pc_mdt_full_data_aav
add wave -noupdate -expand -group hps_int_out -expand -subitemconfig {/hps_tb/HPSOUT/hps_heg_hp2bm_aaav(3) -expand /hps_tb/HPSOUT/hps_heg_hp2bm_aaav(3)(2) -expand /hps_tb/HPSOUT/hps_heg_hp2bm_aaav(3)(2)(5) -expand} /hps_tb/HPSOUT/hps_heg_hp2bm_aaav
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {28875000000 fs} 0}
