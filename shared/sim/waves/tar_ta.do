...
add wave -noupdate -expand -group tar_tb -expand -group generics /tar_tb/g_ST_ACT
add wave -noupdate -expand -group tar_tb -expand -group generics /tar_tb/g_HPS_MAX_HP
add wave -noupdate -expand -group tar_tb -expand -group generics /tar_tb/g_ST_ENABLE
add wave -noupdate -expand -group tar_tb -expand -group generics /tar_tb/PRJ_INFO
add wave -noupdate -expand -group tar_tb -expand -group generics /tar_tb/IN_SLC_FILE
add wave -noupdate -expand -group tar_tb -expand -group generics /tar_tb/IN_HIT_FILE
add wave -noupdate -expand -group tar_tb -expand -group generics /tar_tb/IN_CTRL_FILE
add wave -noupdate -expand -group tar_tb -expand -group generics /tar_tb/DUMMY
add wave -noupdate -expand -group tar_tb -expand -group generics /tar_tb/ST_ENABLE
...
add wave -noupdate -expand -group tar2hps -radix decimal -childformat {{/tar_tb/TAR2HPS/mdt_event_a(0) -radix decimal -childformat {{/tar_tb/TAR2HPS/mdt_event_a(0)(0) -radix decimal} {/tar_tb/TAR2HPS/mdt_event_a(0)(1) -radix decimal} {/tar_tb/TAR2HPS/mdt_event_a(0)(2) -radix decimal} {/tar_tb/TAR2HPS/mdt_event_a(0)(3) -radix decimal} {/tar_tb/TAR2HPS/mdt_event_a(0)(4) -radix decimal} {/tar_tb/TAR2HPS/mdt_event_a(0)(5) -radix decimal}}} {/tar_tb/TAR2HPS/mdt_event_a(1) -radix decimal} {/tar_tb/TAR2HPS/mdt_event_a(2) -radix decimal} {/tar_tb/TAR2HPS/mdt_event_a(3) -radix decimal}} -expand -subitemconfig {/tar_tb/TAR2HPS/mdt_event_a(0) {-height 17 -radix decimal -childformat {{/tar_tb/TAR2HPS/mdt_event_a(0)(0) -radix decimal} {/tar_tb/TAR2HPS/mdt_event_a(0)(1) -radix decimal} {/tar_tb/TAR2HPS/mdt_event_a(0)(2) -radix decimal} {/tar_tb/TAR2HPS/mdt_event_a(0)(3) -radix decimal} {/tar_tb/TAR2HPS/mdt_event_a(0)(4) -radix decimal} {/tar_tb/TAR2HPS/mdt_event_a(0)(5) -radix decimal}} -expand} /tar_tb/TAR2HPS/mdt_event_a(0)(0) {-height 17 -radix decimal} /tar_tb/TAR2HPS/mdt_event_a(0)(1) {-height 17 -radix decimal} /tar_tb/TAR2HPS/mdt_event_a(0)(2) {-height 17 -radix decimal} /tar_tb/TAR2HPS/mdt_event_a(0)(3) {-height 17 -radix decimal} /tar_tb/TAR2HPS/mdt_event_a(0)(4) {-height 17 -radix decimal} /tar_tb/TAR2HPS/mdt_event_a(0)(5) {-height 17 -radix decimal} /tar_tb/TAR2HPS/mdt_event_a(1) {-height 17 -radix decimal} /tar_tb/TAR2HPS/mdt_event_a(2) {-height 17 -radix decimal} /tar_tb/TAR2HPS/mdt_event_a(3) {-height 17 -radix decimal}} /tar_tb/TAR2HPS/mdt_event_a
...
WaveRestoreCursors {{Cursor 1} {499938708403 fs} 0}
...
update
WaveRestoreZoom {499926280334 fs} {500003879983 fs}
