...
package TC_B_S3A_pkg is
  ...
  constant MAX_TUBES_INN : integer := 5;
  constant MAX_TUBES_MID : integer := 8;
  constant MAX_TUBES_OUT : integer := 12;
  -- constant MAX_TUBES_EXT : 5;
  type tube_coordinates_at is array (0 to 1) of integer;
  ...
  constant tube_coordinates_mid :  tube_coord_side_aat(0 to MAX_TUBES_INN - 1)(0 to 6):= (
  ...
  constant tube_coordinates_out :  tube_coord_side_aat(0 to MAX_TUBES_INN - 1)(0 to 6):= (
    --      layer 0       , layer 1       , layer 2       , layer 3       , layer 4       , layer 5       ,
    0  => ((      1,  100),(      1,  100),(      1,  100),(      1,  100),(      1,  100),(      1,  100)), -- tube 0
    1  => ((     10,  100),(     10,  100),(     10,  100),(     10,  100),(     10,  100),(     10,  100)), -- tube 1
    2  => ((    100,  100),(    100,  100),(    100,  100),(    100,  100),(    100,  100),(    100,  100)), -- tube 2
