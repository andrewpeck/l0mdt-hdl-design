...
`include <l0mdt_constants_pkg.svh>
  ...
  parameter real  MDT_GLOBAL_AXI_MULT = 32.0;

  parameter int  MDT_LOCAL_X_LEN = HEG2SFHIT_LOCALX_LEN;

  parameter real  MDT_LOCAL_X_MULT = HEG2SFHIT_LOCALX_MULT;

  parameter int  MDT_LOCAL_Y_LEN = HEG2SFHIT_LOCALY_LEN;

  parameter real  MDT_LOCAL_Y_MULT = HEG2SFHIT_LOCALY_MULT;

  parameter int  MDT_RADIUS_LEN = HEG2SFHIT_RADIUS_LEN;

  parameter real  MDT_RADIUS_MULT = 32.0;
  ...
  parameter real  SLC_Z_RPC_MULT = SLC_BARREL_RPC0_POSZ_MULT;
  ...
  parameter real  UCM_Z_ROI_MULT = UCM2HPS_VEC_POS_MULT;

  parameter int  MDT_LOCAL_AXI_LEN = 14;

  parameter real  MDT_LOCAL_AXI_MULT = 16.0;
  ...
  parameter real  SF_SEG_POS_MULTI = 16.0;

  parameter int  SF_SEG_ANG_LEN = SF2PTCALC_SEGANGLE_LEN;

  parameter real  SF_SEG_ANG_MULTI = 4096.0;
  ...
  parameter real  MTC_PT_MULT = PTCALC2MTC_MDT_PT_MULT;
  ...
  parameter real  BIL_SEC3_RHO = 4755.91;

  parameter real  BML_SEC3_RHO = 6898.4398;

  parameter real  BOL_SEC3_RHO = 9259.4397;
