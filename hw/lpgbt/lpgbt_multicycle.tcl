...
set pipeline_s_reg_cells [get_cells -quiet "top_framework/lpgbt_link_wrapper_inst/*uplink*/*frame_pipelined_s_reg[*]"]
set_property -quiet KEEP true $pipeline_s_reg_cells

set pipeline_s_reg [get_pins -quiet "top_framework/lpgbt_link_wrapper_inst/*uplink*/frame_pipelined_s_reg[*]/C"]
...
set descrambled_d_reg_cells [get_cells -quiet "top_framework/lpgbt_link_wrapper_inst/*uplink*/*descrambler*/*descrambler*/descrambledData_reg*"]
set_property -quiet KEEP true $descrambled_d_reg_cells

set descrambled_d_reg [get_pins -quiet "top_framework/lpgbt_link_wrapper_inst/*uplink*/*descrambler*/*descrambler*/descrambledData_reg*/C"]
...
set scrambled_d_reg_cells [get_cells -quiet "top_framework/*lpgbt_link_wrapper_inst/*downlink_inst*/*_scramble*/scrambledData*"]
set_property -quiet KEEP true $scrambled_d_reg_cells

set scrambled_d_reg [get_pins -quiet "top_framework/lpgbt_link_wrapper_inst/*downlink*/*_scramble*/*scrambledData*/D"]
...
set_property -quiet KEEP true [get_cells -quiet -hierarchical -filter {NAME =~ top_framework/lpgbt_link_wrapper_inst/*/gearboxSyncReset*}]
