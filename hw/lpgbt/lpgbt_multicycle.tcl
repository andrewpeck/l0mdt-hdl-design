...
set pipeline_s_reg [get_pins -hierarchical -filter {NAME =~ *lpgbt_link_wrapper_inst/uplink_gen[*]*/frame_pipelined_s_reg[*]/C}]
set pipeline_s_reg_cells [get_cells -hierarchical -filter {NAME =~ *lpgbt_link_wrapper_inst/uplink_gen[*]*/frame_pipelined_s_reg[*]}]
...
set descrambled_d_reg [get_pins -hierarchical -filter {NAME =~ *lpgbt_link_wrapper_inst/uplink_gen[*]*/*descrambledData_reg[*]/C}]
set descrambled_d_reg_cells [get_cells -hierarchical -filter {NAME =~ *lpgbt_link_wrapper_inst/uplink_gen[*]*/*descrambledData_reg[*]}]
...
set scrambled_d_reg [get_pins -hierarchical -filter {NAME =~ *lpgbt_link_wrapper_inst/downlink_gen[*]*/scrambledData*/D}]
set scrambled_d_reg_cells [get_cells -hierarchical -filter {NAME =~ *lpgbt_link_wrapper_inst/downlink_gen[*]*/scrambledData*}]
