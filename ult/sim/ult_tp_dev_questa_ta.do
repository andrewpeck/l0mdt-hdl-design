...
add wave -noupdate -expand -group CVP2 -expand -group phimod /ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/PHIMOD/g_PIPELINE
add wave -noupdate -expand -group CVP2 -expand -group phimod /ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/PHIMOD/clk
add wave -noupdate -expand -group CVP2 -expand -group phimod /ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/PHIMOD/rst
add wave -noupdate -expand -group CVP2 -expand -group phimod /ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/PHIMOD/SECTOR_PHI
add wave -noupdate -expand -group CVP2 -expand -group phimod /ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/PHIMOD/i_posphi
add wave -noupdate -expand -group CVP2 -expand -group phimod /ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/PHIMOD/o_phimod
add wave -noupdate -expand -group CVP2 -expand -group phimod /ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/PHIMOD/phimod_buff
add wave -noupdate -expand -group CVP2 -expand -group phimod /ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/PHIMOD/sphi_buff
add wave -noupdate -expand -group CVP2 -expand -group phimod /ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/PHIMOD/phicenter
add wave -noupdate -expand -group CVP2 -expand -group phimod /ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/PHIMOD/phicenter_Default
add wave -noupdate -expand -group CVP2 -expand -group phimod /ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/PHIMOD/reschanger
...
add wave -noupdate -expand -group CVP2 -group SLOPE_CALC -radix unsigned -childformat {{/ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/B_SLOPE/SLOPE_CALC/rad_a(0) -radix unsigned} {/ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/B_SLOPE/SLOPE_CALC/rad_a(1) -radix unsigned} {/ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/B_SLOPE/SLOPE_CALC/rad_a(2) -radix unsigned} {/ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/B_SLOPE/SLOPE_CALC/rad_a(3) -radix unsigned}} -expand -subitemconfig {/ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/B_SLOPE/SLOPE_CALC/rad_a(0) {-height 17 -radix unsigned} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/B_SLOPE/SLOPE_CALC/rad_a(1) {-height 17 -radix unsigned} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/B_SLOPE/SLOPE_CALC/rad_a(2) {-height 17 -radix unsigned} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/B_SLOPE/SLOPE_CALC/rad_a(3) {-height 17 -radix unsigned}} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_VP_A(2)/SLC_VP/B_SLOPE/SLOPE_CALC/rad_a
...
WaveRestoreCursors {{Cursor 1} {2004687500 fs} 1} {{Cursor 2} {2353285 fs} 0}
