...
add wave -noupdate -group UCM_Top -expand -group CDE2 /ult_tp/ULT/logic_gen/UCM/UCM/UCM/SLC_CDE_A(2)/SLC_CDE/o_cde_data_null
...
add wave -noupdate -group UCM_Top -color Cyan -expand -subitemconfig {/ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_ar(4) {-color Cyan -height 17 -expand} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_ar(4).data_valid {-color Cyan -height 17} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_ar(4).busy {-color Cyan -height 17} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_ar(4).process_ch {-color Cyan -height 17} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_ar(4).common {-color Cyan -height 17} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_ar(4).phimod {-color Cyan -height 17} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_ar(4).nswseg_angdtheta {-color Cyan -height 17} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_ar(4).nswseg_posphi {-color Cyan -height 17} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_ar(4).nswseg_poseta {-color Cyan -height 17} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_ar(3) {-color Cyan -height 17} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_ar(2) {-color Cyan -height 17} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_ar(1) {-color Cyan -height 17} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_ar(0) {-color Cyan -height 17}} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_ar
add wave -noupdate -group UCM_Top -color Cyan -expand -subitemconfig {/ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_av(4) {-color Cyan -height 17} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_av(3) {-color Cyan -height 17} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_av(2) {-color Cyan -height 17} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_av(1) {-color Cyan -height 17} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_av(0) {-color Cyan -height 17}} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/int_uCM2pl_av
add wave -noupdate -group UCM_Top /ult_tp/ULT/logic_gen/UCM/UCM/UCM/o_uCM2pl_ar
add wave -noupdate -group UCM_Top -expand /ult_tp/ULT/logic_gen/UCM/UCM/UCM/cpam_in_av
add wave -noupdate -group UCM_Top -expand /ult_tp/ULT/logic_gen/UCM/UCM/UCM/cpam_out_av
...
add wave -noupdate -group UCM_Top -expand -subitemconfig {/ult_tp/ULT/logic_gen/UCM/UCM/UCM/uCM2hps_data(2) -expand} /ult_tp/ULT/logic_gen/UCM/UCM/UCM/uCM2hps_data
...
add wave -noupdate -expand -group MPL -expand -group MPL_A4 -expand -group MPCVMEM_A4 -radix unsigned /ult_tp/ULT/logic_gen/pipeline_inst/MPL_EN/MPL/MPL_A(4)/PL/MPCVMEM_GEN/mpcvmem/g_SECOND_PORT
add wave -noupdate -expand -group MPL -expand -group MPL_A4 -expand -group MPCVMEM_A4 -radix unsigned /ult_tp/ULT/logic_gen/pipeline_inst/MPL_EN/MPL/MPL_A(4)/PL/MPCVMEM_GEN/mpcvmem/g_IN_PIPELINE
add wave -noupdate -expand -group MPL -expand -group MPL_A4 -expand -group MPCVMEM_A4 -radix unsigned /ult_tp/ULT/logic_gen/pipeline_inst/MPL_EN/MPL/MPL_A(4)/PL/MPCVMEM_GEN/mpcvmem/g_OUT_PIPELINE
...
WaveRestoreCursors {Reset {7812500 fs} 1} {{Cursor 2} {4800319945 fs} 0}
...
update
WaveRestoreZoom {4729926763 fs} {5014214381 fs}
