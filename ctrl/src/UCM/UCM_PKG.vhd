...
package UCM_CTRL is
  ...
  type UCM_CHAMBER_Z0_CHAMBER_Z0_CALC_WR_CTRL_t is record
  ...
  end record UCM_CHAMBER_Z0_CHAMBER_Z0_CALC_WR_CTRL_t;


  constant DEFAULT_UCM_CHAMBER_Z0_CHAMBER_Z0_CALC_WR_CTRL_t : UCM_CHAMBER_Z0_CHAMBER_Z0_CALC_WR_CTRL_t := (
                                                                                                           WR_EN => '0',
                                                                                                           ADDR => (others => '0'),
                                                                                                           VALUE => (others => '0')
                                                                                                          );
  type UCM_CHAMBER_Z0_CHAMBER_Z0_CALC_RD_MON_t is record
  ...
  end record UCM_CHAMBER_Z0_CHAMBER_Z0_CALC_RD_MON_t;


  type UCM_CHAMBER_Z0_CHAMBER_Z0_MON_t is record
    CALC_RD                    :UCM_CHAMBER_Z0_CHAMBER_Z0_CALC_RD_MON_t;
  end record UCM_CHAMBER_Z0_CHAMBER_Z0_MON_t;
  type UCM_CHAMBER_Z0_CHAMBER_Z0_MON_t_ARRAY is array(0 to 3) of UCM_CHAMBER_Z0_CHAMBER_Z0_MON_t;

  type UCM_CHAMBER_Z0_CHAMBER_Z0_CTRL_t is record
    CALC_WR                    :UCM_CHAMBER_Z0_CHAMBER_Z0_CALC_WR_CTRL_t;
  end record UCM_CHAMBER_Z0_CHAMBER_Z0_CTRL_t;
  type UCM_CHAMBER_Z0_CHAMBER_Z0_CTRL_t_ARRAY is array(0 to 3) of UCM_CHAMBER_Z0_CHAMBER_Z0_CTRL_t;

  constant DEFAULT_UCM_CHAMBER_Z0_CHAMBER_Z0_CTRL_t : UCM_CHAMBER_Z0_CHAMBER_Z0_CTRL_t := (
                                                                                           CALC_WR => DEFAULT_UCM_CHAMBER_Z0_CHAMBER_Z0_CALC_WR_CTRL_t
                                                                                          );
  type UCM_CHAMBER_Z0_MON_t is record
    CHAMBER_Z0                 :UCM_CHAMBER_Z0_CHAMBER_Z0_MON_t_ARRAY;
  end record UCM_CHAMBER_Z0_MON_t;


  type UCM_CHAMBER_Z0_CTRL_t is record
    CHAMBER_Z0                 :UCM_CHAMBER_Z0_CHAMBER_Z0_CTRL_t_ARRAY;
  end record UCM_CHAMBER_Z0_CTRL_t;


  constant DEFAULT_UCM_CHAMBER_Z0_CTRL_t : UCM_CHAMBER_Z0_CTRL_t := (
                                                                     CHAMBER_Z0 => (others => DEFAULT_UCM_CHAMBER_Z0_CHAMBER_Z0_CTRL_t )
                                                                    );
