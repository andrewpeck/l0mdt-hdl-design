...
begin  -- architecture behavioral
  ...
  begin  -- process reads
    ...
    if localRdReq = '1' then
      ...
      case to_integer(unsigned(localAddress(14 downto 0))) is
        ...
        when 260 => --0x104
          localRdData(31 downto 16)  <=  reg_data(260)(31 downto 16);                      --
        when 262 => --0x106
          localRdData(31 downto  0)  <=  Mon.HPS(0).LSF.LSF(0).sb_lsf_mdt_hits_rdata;      --
        when 273 => --0x111
        ...
        when 276 => --0x114
          localRdData(31 downto 16)  <=  reg_data(276)(31 downto 16);                      --
        when 278 => --0x116
          localRdData(31 downto  0)  <=  Mon.HPS(0).LSF.LSF(1).sb_lsf_mdt_hits_rdata;      --
        when 289 => --0x121
        ...
        when 292 => --0x124
          localRdData(31 downto 16)  <=  reg_data(292)(31 downto 16);                      --
        when 294 => --0x126
          localRdData(31 downto  0)  <=  Mon.HPS(0).LSF.LSF(2).sb_lsf_mdt_hits_rdata;      --
        when 513 => --0x201
        ...
        when 4356 => --0x1104
          localRdData(31 downto 16)  <=  reg_data(4356)(31 downto 16);                     --
        when 4358 => --0x1106
          localRdData(31 downto  0)  <=  Mon.HPS(1).LSF.LSF(0).sb_lsf_mdt_hits_rdata;      --
        when 4369 => --0x1111
        ...
        when 4372 => --0x1114
          localRdData(31 downto 16)  <=  reg_data(4372)(31 downto 16);                     --
        when 4374 => --0x1116
          localRdData(31 downto  0)  <=  Mon.HPS(1).LSF.LSF(1).sb_lsf_mdt_hits_rdata;      --
        when 4385 => --0x1121
        ...
        when 4388 => --0x1124
          localRdData(31 downto 16)  <=  reg_data(4388)(31 downto 16);                     --
        when 4390 => --0x1126
          localRdData(31 downto  0)  <=  Mon.HPS(1).LSF.LSF(2).sb_lsf_mdt_hits_rdata;      --
        when 4609 => --0x1201
        ...
        when 8452 => --0x2104
          localRdData(31 downto 16)  <=  reg_data(8452)(31 downto 16);                     --
        when 8454 => --0x2106
          localRdData(31 downto  0)  <=  Mon.HPS(2).LSF.LSF(0).sb_lsf_mdt_hits_rdata;      --
        when 8465 => --0x2111
        ...
        when 8468 => --0x2114
          localRdData(31 downto 16)  <=  reg_data(8468)(31 downto 16);                     --
        when 8470 => --0x2116
          localRdData(31 downto  0)  <=  Mon.HPS(2).LSF.LSF(1).sb_lsf_mdt_hits_rdata;      --
        when 8481 => --0x2121
        ...
        when 8484 => --0x2124
          localRdData(31 downto 16)  <=  reg_data(8484)(31 downto 16);                     --
        when 8486 => --0x2126
          localRdData(31 downto  0)  <=  Mon.HPS(2).LSF.LSF(2).sb_lsf_mdt_hits_rdata;      --
        when 8705 => --0x2201
        ...
        when 16644 => --0x4104
          localRdData(31 downto 16)  <=  reg_data(16644)(31 downto 16);                    --
        when 16646 => --0x4106
          localRdData(31 downto  0)  <=  Mon.HPS(3).LSF.LSF(0).sb_lsf_mdt_hits_rdata;      --
        when 16657 => --0x4111
        ...
        when 16660 => --0x4114
          localRdData(31 downto 16)  <=  reg_data(16660)(31 downto 16);                    --
        when 16662 => --0x4116
          localRdData(31 downto  0)  <=  Mon.HPS(3).LSF.LSF(1).sb_lsf_mdt_hits_rdata;      --
        when 16673 => --0x4121
        ...
        when 16676 => --0x4124
          localRdData(31 downto 16)  <=  reg_data(16676)(31 downto 16);                    --
        when 16678 => --0x4126
          localRdData(31 downto  0)  <=  Mon.HPS(3).LSF.LSF(2).sb_lsf_mdt_hits_rdata;      --
        when 16897 => --0x4201
  ...
  Ctrl.HPS(3).LSF.LSF(0).sb_lsf_mdt_hits_raddr   <=  reg_data(16644)(31 downto 16);     
  ...
  Ctrl.HPS(3).LSF.LSF(1).sb_lsf_mdt_hits_raddr   <=  reg_data(16660)(31 downto 16);     
  ...
  Ctrl.HPS(3).LSF.LSF(2).sb_lsf_mdt_hits_raddr   <=  reg_data(16676)(31 downto 16);     
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      reg_data(260)(31 downto 16)  <= DEFAULT_H2S_CTRL_t.HPS(0).LSF.LSF(0).sb_lsf_mdt_hits_raddr;
      ...
      reg_data(276)(31 downto 16)  <= DEFAULT_H2S_CTRL_t.HPS(0).LSF.LSF(1).sb_lsf_mdt_hits_raddr;
      ...
      reg_data(292)(31 downto 16)  <= DEFAULT_H2S_CTRL_t.HPS(0).LSF.LSF(2).sb_lsf_mdt_hits_raddr;
      ...
      reg_data(4356)(31 downto 16)  <= DEFAULT_H2S_CTRL_t.HPS(1).LSF.LSF(0).sb_lsf_mdt_hits_raddr;
      ...
      reg_data(4372)(31 downto 16)  <= DEFAULT_H2S_CTRL_t.HPS(1).LSF.LSF(1).sb_lsf_mdt_hits_raddr;
      ...
      reg_data(4388)(31 downto 16)  <= DEFAULT_H2S_CTRL_t.HPS(1).LSF.LSF(2).sb_lsf_mdt_hits_raddr;
      ...
      reg_data(8452)(31 downto 16)  <= DEFAULT_H2S_CTRL_t.HPS(2).LSF.LSF(0).sb_lsf_mdt_hits_raddr;
      ...
      reg_data(8468)(31 downto 16)  <= DEFAULT_H2S_CTRL_t.HPS(2).LSF.LSF(1).sb_lsf_mdt_hits_raddr;
      ...
      reg_data(8484)(31 downto 16)  <= DEFAULT_H2S_CTRL_t.HPS(2).LSF.LSF(2).sb_lsf_mdt_hits_raddr;
      ...
      reg_data(16644)(31 downto 16)  <= DEFAULT_H2S_CTRL_t.HPS(3).LSF.LSF(0).sb_lsf_mdt_hits_raddr;
      ...
      reg_data(16660)(31 downto 16)  <= DEFAULT_H2S_CTRL_t.HPS(3).LSF.LSF(1).sb_lsf_mdt_hits_raddr;
      ...
      reg_data(16676)(31 downto 16)  <= DEFAULT_H2S_CTRL_t.HPS(3).LSF.LSF(2).sb_lsf_mdt_hits_raddr;
      ...
      if localWrEn = '1' then
        ...
        when 260 => --0x104
          reg_data(260)(31 downto 16)                <=  localWrData(31 downto 16);      --
        when 272 => --0x110
        ...
        when 276 => --0x114
          reg_data(276)(31 downto 16)                <=  localWrData(31 downto 16);      --
        when 288 => --0x120
        ...
        when 292 => --0x124
          reg_data(292)(31 downto 16)                <=  localWrData(31 downto 16);      --
        when 512 => --0x200
        ...
        when 4356 => --0x1104
          reg_data(4356)(31 downto 16)               <=  localWrData(31 downto 16);      --
        when 4368 => --0x1110
        ...
        when 4372 => --0x1114
          reg_data(4372)(31 downto 16)               <=  localWrData(31 downto 16);      --
        when 4384 => --0x1120
        ...
        when 4388 => --0x1124
          reg_data(4388)(31 downto 16)               <=  localWrData(31 downto 16);      --
        when 4608 => --0x1200
        ...
        when 8452 => --0x2104
          reg_data(8452)(31 downto 16)               <=  localWrData(31 downto 16);      --
        when 8464 => --0x2110
        ...
        when 8468 => --0x2114
          reg_data(8468)(31 downto 16)               <=  localWrData(31 downto 16);      --
        when 8480 => --0x2120
        ...
        when 8484 => --0x2124
          reg_data(8484)(31 downto 16)               <=  localWrData(31 downto 16);      --
        when 8704 => --0x2200
        ...
        when 16644 => --0x4104
          reg_data(16644)(31 downto 16)              <=  localWrData(31 downto 16);      --
        when 16656 => --0x4110
        ...
        when 16660 => --0x4114
          reg_data(16660)(31 downto 16)              <=  localWrData(31 downto 16);      --
        when 16672 => --0x4120
        ...
        when 16676 => --0x4124
          reg_data(16676)(31 downto 16)              <=  localWrData(31 downto 16);      --
        when 16896 => --0x4200
