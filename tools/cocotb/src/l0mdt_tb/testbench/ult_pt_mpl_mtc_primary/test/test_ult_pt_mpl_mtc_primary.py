...
from l0mdt_tb.testbench.ult_pt_mpl_mtc_primary.ult_pt_mpl_mtc_primary_ports import UltPtMplMtcPrimaryPorts
...
def ult_pt_mpl_mtc_primary_test(dut):
   ...
   ###Get Output Test Vector List for Ports across all output interfaces##
    ...
    events.results_summary(
        ...
        field_fail_cnt_header,
        field_fail_cnt,
        total_ports=UltPtMplMtcPrimaryPorts.n_output_ports(UltPtMplMtcPrimaryPorts)
    )
