...
class UltUcmPtMplMtcWrapper(block_wrapper.BlockWrapper):
    def __init__(self, clock, name):
        super().__init__(
            clock,
            name,
            UltUcmPtMplMtcPorts.get_all_input_interface_ports(),
            UltUcmPtMplMtcPorts.get_all_output_interface_ports(),
        )
