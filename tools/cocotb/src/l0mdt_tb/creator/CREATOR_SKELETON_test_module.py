...
def CREATORTESTNAME_test(dut):
   ...
   ###Get Output Test Vector List for Ports across all output interfaces##
    ...
    for n_op_intf in range (CREATORCLASSNAMEPorts.n_output_interfaces):
        events_are_equal, pass_count , fail_count = events.compare_BitFields(tv_bcid_list, output_tvformats[n_op_intf],CREATORCLASSNAMEPorts.get_output_interface_ports(n_op_intf) , num_events_to_process , recvd_events_intf[n_op_intf],tolerance[n_op_intf],output_dir);
