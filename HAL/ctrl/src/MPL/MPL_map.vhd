...
begin  -- architecture behavioral
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      Ctrl.PL_MEM.PL_MEM(0).SIGNALS.flush_req <= '0';
      ...
      Ctrl.PL_MEM.PL_MEM(1).SIGNALS.flush_req <= '0';
      ...
      Ctrl.PL_MEM.PL_MEM(2).SIGNALS.flush_req <= '0';
      ...
      Ctrl.PL_MEM.PL_MEM(3).SIGNALS.flush_req <= '0';
      ...
      Ctrl.PL_MEM.PL_MEM(4).SIGNALS.flush_req <= '0';
      ...
      if localWrEn = '1' then
        ...
        when 256 => --0x100
          ...
          Ctrl.PL_MEM.PL_MEM(0).SIGNALS.flush_req  <=  localWrData( 4);               
        when 258 => --0x102
        ...
        when 272 => --0x110
          ...
          Ctrl.PL_MEM.PL_MEM(1).SIGNALS.flush_req  <=  localWrData( 4);               
        when 274 => --0x112
        ...
        when 288 => --0x120
          ...
          Ctrl.PL_MEM.PL_MEM(2).SIGNALS.flush_req  <=  localWrData( 4);               
        when 290 => --0x122
        ...
        when 304 => --0x130
          ...
          Ctrl.PL_MEM.PL_MEM(3).SIGNALS.flush_req  <=  localWrData( 4);               
        when 306 => --0x132
        ...
        when 320 => --0x140
          ...
          Ctrl.PL_MEM.PL_MEM(4).SIGNALS.flush_req  <=  localWrData( 4);               
        when 322 => --0x142
