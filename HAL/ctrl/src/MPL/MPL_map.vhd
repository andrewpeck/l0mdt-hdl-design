...
entity MPL_map is
  generic (
    ...
    ALLOCATED_MEMORY_RANGE : integer := 1024
    );
  port (
...
begin  -- architecture behavioral
    ...
    if reset_axi_n = '0' then
      ...
      if localRdReq = '1' then
        ...
        when 256 => --0x100
          ...
          localRdData( 5)            <=  Mon.PL_MEM.PL_MEM(0).SIGNALS.freeze_ena;      --freeze memory
          localRdData( 5)            <=  reg_data(256)( 5);                            --freeze memory
          localRdData( 8 downto  6)  <=  reg_data(256)( 8 downto  6);                  --sel memory
        when 258 => --0x102
        ...
        when 272 => --0x110
          localRdData( 0)            <=  Mon.PL_MEM.PL_MEM(1).SIGNALS.rd_rdy;          --Read ready
          localRdData( 4)            <=  reg_data(272)( 4);                            --flush memory to Zync
          localRdData( 5)            <=  Mon.PL_MEM.PL_MEM(1).SIGNALS.freeze_ena;      --freeze memory
          localRdData( 5)            <=  reg_data(272)( 5);                            --freeze memory
          localRdData( 8 downto  6)  <=  reg_data(272)( 8 downto  6);                  --sel memory
        when 274 => --0x112
        ...
        when 288 => --0x120
          localRdData( 0)            <=  Mon.PL_MEM.PL_MEM(2).SIGNALS.rd_rdy;          --Read ready
          localRdData( 4)            <=  reg_data(288)( 4);                            --flush memory to Zync
          localRdData( 5)            <=  Mon.PL_MEM.PL_MEM(2).SIGNALS.freeze_ena;      --freeze memory
          localRdData( 5)            <=  reg_data(288)( 5);                            --freeze memory
          localRdData( 8 downto  6)  <=  reg_data(288)( 8 downto  6);                  --sel memory
        when 290 => --0x122
        ...
        when 304 => --0x130
          localRdData( 0)            <=  Mon.PL_MEM.PL_MEM(3).SIGNALS.rd_rdy;          --Read ready
          localRdData( 4)            <=  reg_data(304)( 4);                            --flush memory to Zync
          localRdData( 5)            <=  Mon.PL_MEM.PL_MEM(3).SIGNALS.freeze_ena;      --freeze memory
          localRdData( 5)            <=  reg_data(304)( 5);                            --freeze memory
          localRdData( 8 downto  6)  <=  reg_data(304)( 8 downto  6);                  --sel memory
        when 306 => --0x132
        ...
        when 320 => --0x140
          localRdData( 0)            <=  Mon.PL_MEM.PL_MEM(4).SIGNALS.rd_rdy;          --Read ready
          localRdData( 4)            <=  reg_data(320)( 4);                            --flush memory to Zync
          localRdData( 5)            <=  Mon.PL_MEM.PL_MEM(4).SIGNALS.freeze_ena;      --freeze memory
          localRdData( 5)            <=  reg_data(320)( 5);                            --freeze memory
          localRdData( 8 downto  6)  <=  reg_data(320)( 8 downto  6);                  --sel memory
        when 322 => --0x142
  ...
  Ctrl.PL_MEM.PL_MEM(1).SIGNALS.flush_req   <=  reg_data(272)( 4);               
  Ctrl.PL_MEM.PL_MEM(1).SIGNALS.freeze_req  <=  reg_data(272)( 5);               
  Ctrl.PL_MEM.PL_MEM(1).SIGNALS.mem_sel     <=  reg_data(272)( 8 downto  6);     
  ...
  Ctrl.PL_MEM.PL_MEM(2).SIGNALS.flush_req   <=  reg_data(288)( 4);               
  Ctrl.PL_MEM.PL_MEM(2).SIGNALS.freeze_req  <=  reg_data(288)( 5);               
  Ctrl.PL_MEM.PL_MEM(2).SIGNALS.mem_sel     <=  reg_data(288)( 8 downto  6);     
  ...
  Ctrl.PL_MEM.PL_MEM(3).SIGNALS.flush_req   <=  reg_data(304)( 4);               
  Ctrl.PL_MEM.PL_MEM(3).SIGNALS.freeze_req  <=  reg_data(304)( 5);               
  Ctrl.PL_MEM.PL_MEM(3).SIGNALS.mem_sel     <=  reg_data(304)( 8 downto  6);     
  ...
  Ctrl.PL_MEM.PL_MEM(4).SIGNALS.flush_req   <=  reg_data(320)( 4);               
  Ctrl.PL_MEM.PL_MEM(4).SIGNALS.freeze_req  <=  reg_data(320)( 5);               
  Ctrl.PL_MEM.PL_MEM(4).SIGNALS.mem_sel     <=  reg_data(320)( 8 downto  6);     
    ...
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      if localWrEn = '1' then
        ...
        when 256 => --0x100
          ...
          reg_data(256)( 4)                     <=  localWrData( 4);                --flush memory to Zync
          reg_data(256)( 5)                     <=  localWrData( 5);                --freeze memory
          reg_data(256)( 8 downto  6)           <=  localWrData( 8 downto  6);      --sel memory
        when 258 => --0x102
        ...
        when 272 => --0x110
          ...
          reg_data(272)( 4)                     <=  localWrData( 4);                --flush memory to Zync
          reg_data(272)( 5)                     <=  localWrData( 5);                --freeze memory
          reg_data(272)( 8 downto  6)           <=  localWrData( 8 downto  6);      --sel memory
        when 274 => --0x112
        ...
        when 288 => --0x120
          ...
          reg_data(288)( 4)                     <=  localWrData( 4);                --flush memory to Zync
          reg_data(288)( 5)                     <=  localWrData( 5);                --freeze memory
          reg_data(288)( 8 downto  6)           <=  localWrData( 8 downto  6);      --sel memory
        when 290 => --0x122
        ...
        when 304 => --0x130
          ...
          reg_data(304)( 4)                     <=  localWrData( 4);                --flush memory to Zync
          reg_data(304)( 5)                     <=  localWrData( 5);                --freeze memory
          reg_data(304)( 8 downto  6)           <=  localWrData( 8 downto  6);      --sel memory
        when 306 => --0x132
        ...
        when 320 => --0x140
          ...
          reg_data(320)( 4)                     <=  localWrData( 4);                --flush memory to Zync
          reg_data(320)( 5)                     <=  localWrData( 5);                --freeze memory
          reg_data(320)( 8 downto  6)           <=  localWrData( 8 downto  6);      --sel memory
        when 322 => --0x142
