...
begin  -- architecture behavioral
  ...
  begin  -- process reads
    ...
    if localRdReq = '1' then
      ...
      case to_integer(unsigned(localAddress(14 downto 0))) is
        ...
        when 12550 => --0x3106
          localRdData( 9 downto  0)  <=  reg_data(12550)( 9 downto  0);               --wr_Address
          localRdData(13)            <=  Mon.PL_MEM.PL_MEM(3).rd_rdy;                 --Read ready
          localRdData(25 downto 16)  <=  reg_data(12550)(25 downto 16);               --rd_Address
        when 4388 => --0x1124
  ...
  Ctrl.PL_MEM.PL_MEM(3).wr_addr            <=  reg_data(12550)( 9 downto  0);     
  Ctrl.PL_MEM.PL_MEM(3).rd_addr            <=  reg_data(12550)(25 downto 16);     
  ...
  Ctrl.PL_MEM.PL_MEM(4).wr_addr            <=  reg_data(16646)( 9 downto  0);     
  Ctrl.PL_MEM.PL_MEM(4).rd_addr            <=  reg_data(16646)(25 downto 16);     
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      reg_data(12550)( 9 downto  0)  <= DEFAULT_MPL_CTRL_t.PL_MEM.PL_MEM(3).wr_addr;
      reg_data(12550)(25 downto 16)  <= DEFAULT_MPL_CTRL_t.PL_MEM.PL_MEM(3).rd_addr;
      ...
      reg_data(16646)( 9 downto  0)  <= DEFAULT_MPL_CTRL_t.PL_MEM.PL_MEM(4).wr_addr;
      reg_data(16646)(25 downto 16)  <= DEFAULT_MPL_CTRL_t.PL_MEM.PL_MEM(4).rd_addr;
      ...
      if localWrEn = '1' then
        ...
        when 260 => --0x104
          ...
          Ctrl.PL_MEM.PL_MEM(0).flush_req  <=  localWrData( 2);               
        when 278 => --0x116
        ...
        when 8452 => --0x2104
          ...
          Ctrl.PL_MEM.PL_MEM(2).flush_req  <=  localWrData( 2);               
        when 12565 => --0x3115
        ...
        when 4356 => --0x1104
          ...
          Ctrl.PL_MEM.PL_MEM(1).flush_req  <=  localWrData( 2);               
        when 262 => --0x106
        ...
        when 12548 => --0x3104
          ...
          Ctrl.PL_MEM.PL_MEM(3).flush_req  <=  localWrData( 2);               
        when 16644 => --0x4104
          Ctrl.PL_MEM.PL_MEM(4).wr_req     <=  localWrData( 0);               
          Ctrl.PL_MEM.PL_MEM(4).rd_ack     <=  localWrData( 1);               
          Ctrl.PL_MEM.PL_MEM(4).flush_req  <=  localWrData( 2);               
        when 12566 => --0x3116
        ...
        when 12550 => --0x3106
          reg_data(12550)( 9 downto  0)    <=  localWrData( 9 downto  0);      --wr_Address
          reg_data(12550)(25 downto 16)    <=  localWrData(25 downto 16);      --rd_Address
        when 16646 => --0x4106
