...
architecture behavioral of HAL_CORE_map is
  ...
  signal reg_data :  slv32_array_t(integer range 0 to 825);
  constant Default_reg_data : slv32_array_t(integer range 0 to 825) := (others => x"00000000");
begin  -- architecture behavioral
  ...
  -------------------------------------------------------------------------------
  -------------------------------------------------------------------------------
  assert ((4*825) <= ALLOCATED_MEMORY_RANGE)
    report "HAL_CORE: Regmap addressing range " & integer'image(4*825) & " is outside of AXI mapped range " & integer'image(ALLOCATED_MEMORY_RANGE)
  severity ERROR;
  assert ((4*825) > ALLOCATED_MEMORY_RANGE)
    report "HAL_CORE: Regmap addressing range " & integer'image(4*825) & " is inside of AXI mapped range " & integer'image(ALLOCATED_MEMORY_RANGE)
  severity NOTE;
