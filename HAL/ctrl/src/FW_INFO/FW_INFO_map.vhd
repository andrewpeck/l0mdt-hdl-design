...
begin  -- architecture behavioral
  ...
  -------------------------------------------------------------------------------
  -------------------------------------------------------------------------------
  assert ((4*75) <= ALLOCATED_MEMORY_RANGE)
    report "FW_INFO: Regmap addressing range " & integer'image(4*75) & " is outside of AXI mapped range " & integer'image(ALLOCATED_MEMORY_RANGE)
  severity ERROR;
  assert ((4*75) > ALLOCATED_MEMORY_RANGE)
    report "FW_INFO: Regmap addressing range " & integer'image(4*75) & " is inside of AXI mapped range " & integer'image(ALLOCATED_MEMORY_RANGE)
  severity NOTE;
