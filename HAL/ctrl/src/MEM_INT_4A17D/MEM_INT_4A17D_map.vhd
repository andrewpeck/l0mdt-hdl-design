...
entity MEM_INT_4A17D_interface is
  port (
...
end entity MEM_INT_4A17D_interface;
architecture behavioral of MEM_INT_4A17D_interface is
...
begin  -- architecture behavioral
  ...
  begin  -- process reads
    ...
    if localRdReq = '1' then
      ...
      case to_integer(unsigned(localAddress(5 downto 0))) is
        ...
        when 16 => --0x10
          localRdData(16 downto  0)  <=  reg_data(16)(16 downto  0);      -- Write Data 0
        when 1 => --0x1
  ...
  Ctrl.wr_data.wr_data_0  <=  reg_data(16)(16 downto  0);     
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      reg_data(16)(16 downto  0)  <= DEFAULT_MEM_INT_4A17D_CTRL_t.wr_data.wr_data_0;
      ...
      if localWrEn = '1' then
        ...
        when 16 => --0x10
          reg_data(16)(16 downto  0)  <=  localWrData(16 downto  0);      -- Write Data 0
        when 2 => --0x2
