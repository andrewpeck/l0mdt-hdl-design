...
entity TAR_map is
  generic (
    ...
    ALLOCATED_MEMORY_RANGE : integer := 16384
    );
  port (
...
begin  -- architecture behavioral
  ...
  begin  -- process latch_reads
    if reset_axi_n = '0' then
      ...
      if localRdReq = '1' then
        ...
        when 2064 => --0x810
          localRdData( 0)            <=  Mon.PL_ST.PL_MEM(0).SIGNALS.rd_rdy;          --Read ready
          localRdData( 4)            <=  reg_data(2064)( 4);                          --flush memory to Zync
          localRdData( 5)            <=  Mon.PL_ST.PL_MEM(0).SIGNALS.freeze_ena;      --freeze memory
          localRdData( 5)            <=  reg_data(2064)( 5);                          --freeze memory
          localRdData( 8 downto  6)  <=  reg_data(2064)( 8 downto  6);                --sel memory
        when 2066 => --0x812
        ...
        when 2080 => --0x820
          localRdData( 0)            <=  Mon.PL_ST.PL_MEM(1).SIGNALS.rd_rdy;          --Read ready
          localRdData( 4)            <=  reg_data(2080)( 4);                          --flush memory to Zync
          localRdData( 5)            <=  Mon.PL_ST.PL_MEM(1).SIGNALS.freeze_ena;      --freeze memory
          localRdData( 5)            <=  reg_data(2080)( 5);                          --freeze memory
          localRdData( 8 downto  6)  <=  reg_data(2080)( 8 downto  6);                --sel memory
        when 2082 => --0x822
        ...
        when 2096 => --0x830
          localRdData( 0)            <=  Mon.PL_ST.PL_MEM(2).SIGNALS.rd_rdy;          --Read ready
          localRdData( 4)            <=  reg_data(2096)( 4);                          --flush memory to Zync
          localRdData( 5)            <=  Mon.PL_ST.PL_MEM(2).SIGNALS.freeze_ena;      --freeze memory
          localRdData( 5)            <=  reg_data(2096)( 5);                          --freeze memory
          localRdData( 8 downto  6)  <=  reg_data(2096)( 8 downto  6);                --sel memory
        when 2098 => --0x832
        ...
        when 2112 => --0x840
          localRdData( 0)            <=  Mon.PL_ST.PL_MEM(3).SIGNALS.rd_rdy;          --Read ready
          localRdData( 4)            <=  reg_data(2112)( 4);                          --flush memory to Zync
          localRdData( 5)            <=  Mon.PL_ST.PL_MEM(3).SIGNALS.freeze_ena;      --freeze memory
          localRdData( 5)            <=  reg_data(2112)( 5);                          --freeze memory
          localRdData( 8 downto  6)  <=  reg_data(2112)( 8 downto  6);                --sel memory
        when 2114 => --0x842
        ...
        when 2128 => --0x850
          localRdData( 0)            <=  Mon.PL_ST.PL_MEM(4).SIGNALS.rd_rdy;          --Read ready
          localRdData( 4)            <=  reg_data(2128)( 4);                          --flush memory to Zync
          localRdData( 5)            <=  Mon.PL_ST.PL_MEM(4).SIGNALS.freeze_ena;      --freeze memory
          localRdData( 5)            <=  reg_data(2128)( 5);                          --freeze memory
          localRdData( 8 downto  6)  <=  reg_data(2128)( 8 downto  6);                --sel memory
        when 2130 => --0x852
        ...
        when 2144 => --0x860
          localRdData( 0)            <=  Mon.PL_ST.PL_MEM(5).SIGNALS.rd_rdy;          --Read ready
          localRdData( 4)            <=  reg_data(2144)( 4);                          --flush memory to Zync
          localRdData( 5)            <=  Mon.PL_ST.PL_MEM(5).SIGNALS.freeze_ena;      --freeze memory
          localRdData( 5)            <=  reg_data(2144)( 5);                          --freeze memory
          localRdData( 8 downto  6)  <=  reg_data(2144)( 8 downto  6);                --sel memory
        when 2146 => --0x862
  ...
  Ctrl.PL_ST.PL_MEM(0).SIGNALS.flush_req   <=  reg_data(2064)( 4);               
  Ctrl.PL_ST.PL_MEM(0).SIGNALS.freeze_req  <=  reg_data(2064)( 5);               
  Ctrl.PL_ST.PL_MEM(0).SIGNALS.mem_sel     <=  reg_data(2064)( 8 downto  6);     
  ...
  Ctrl.PL_ST.PL_MEM(1).SIGNALS.flush_req   <=  reg_data(2080)( 4);               
  Ctrl.PL_ST.PL_MEM(1).SIGNALS.freeze_req  <=  reg_data(2080)( 5);               
  Ctrl.PL_ST.PL_MEM(1).SIGNALS.mem_sel     <=  reg_data(2080)( 8 downto  6);     
  ...
  Ctrl.PL_ST.PL_MEM(2).SIGNALS.flush_req   <=  reg_data(2096)( 4);               
  Ctrl.PL_ST.PL_MEM(2).SIGNALS.freeze_req  <=  reg_data(2096)( 5);               
  Ctrl.PL_ST.PL_MEM(2).SIGNALS.mem_sel     <=  reg_data(2096)( 8 downto  6);     
  ...
  Ctrl.PL_ST.PL_MEM(3).SIGNALS.flush_req   <=  reg_data(2112)( 4);               
  Ctrl.PL_ST.PL_MEM(3).SIGNALS.freeze_req  <=  reg_data(2112)( 5);               
  Ctrl.PL_ST.PL_MEM(3).SIGNALS.mem_sel     <=  reg_data(2112)( 8 downto  6);     
  ...
  Ctrl.PL_ST.PL_MEM(4).SIGNALS.flush_req   <=  reg_data(2128)( 4);               
  Ctrl.PL_ST.PL_MEM(4).SIGNALS.freeze_req  <=  reg_data(2128)( 5);               
  Ctrl.PL_ST.PL_MEM(4).SIGNALS.mem_sel     <=  reg_data(2128)( 8 downto  6);     
  ...
  Ctrl.PL_ST.PL_MEM(5).SIGNALS.flush_req   <=  reg_data(2144)( 4);               
  Ctrl.PL_ST.PL_MEM(5).SIGNALS.freeze_req  <=  reg_data(2144)( 5);               
  Ctrl.PL_ST.PL_MEM(5).SIGNALS.mem_sel     <=  reg_data(2144)( 8 downto  6);     
    ...
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      if localWrEn = '1' then
        ...
        when 2064 => --0x810
          ...
          reg_data(2064)( 4)                   <=  localWrData( 4);                --flush memory to Zync
          reg_data(2064)( 5)                   <=  localWrData( 5);                --freeze memory
          reg_data(2064)( 8 downto  6)         <=  localWrData( 8 downto  6);      --sel memory
        when 2066 => --0x812
        ...
        when 2080 => --0x820
          ...
          reg_data(2080)( 4)                   <=  localWrData( 4);                --flush memory to Zync
          reg_data(2080)( 5)                   <=  localWrData( 5);                --freeze memory
          reg_data(2080)( 8 downto  6)         <=  localWrData( 8 downto  6);      --sel memory
        when 2082 => --0x822
        ...
        when 2096 => --0x830
          ...
          reg_data(2096)( 4)                   <=  localWrData( 4);                --flush memory to Zync
          reg_data(2096)( 5)                   <=  localWrData( 5);                --freeze memory
          reg_data(2096)( 8 downto  6)         <=  localWrData( 8 downto  6);      --sel memory
        when 2098 => --0x832
        ...
        when 2112 => --0x840
          ...
          reg_data(2112)( 4)                   <=  localWrData( 4);                --flush memory to Zync
          reg_data(2112)( 5)                   <=  localWrData( 5);                --freeze memory
          reg_data(2112)( 8 downto  6)         <=  localWrData( 8 downto  6);      --sel memory
        when 2114 => --0x842
        ...
        when 2128 => --0x850
          ...
          reg_data(2128)( 4)                   <=  localWrData( 4);                --flush memory to Zync
          reg_data(2128)( 5)                   <=  localWrData( 5);                --freeze memory
          reg_data(2128)( 8 downto  6)         <=  localWrData( 8 downto  6);      --sel memory
        when 2130 => --0x852
        ...
        when 2144 => --0x860
          reg_data(2144)( 4)                   <=  localWrData( 4);                --flush memory to Zync
          ...
          reg_data(2144)( 5)                   <=  localWrData( 5);                --freeze memory
          reg_data(2144)( 8 downto  6)         <=  localWrData( 8 downto  6);      --sel memory
        when 2146 => --0x862
