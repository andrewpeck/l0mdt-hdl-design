...
begin  -- architecture behavioral
    ...
    if reset_axi_n = '0' then
      ...
      if localRdReq = '1' then
        ...
        when 2064 => --0x810
          ...
          localRdData( 8)            <=  reg_data(2064)( 8);                          --sel memory
        when 2066 => --0x812
        ...
        when 2080 => --0x820
          ...
          localRdData( 8)            <=  reg_data(2080)( 8);                          --sel memory
        when 2082 => --0x822
        ...
        when 2096 => --0x830
          ...
          localRdData( 8)            <=  reg_data(2096)( 8);                          --sel memory
        when 2098 => --0x832
        ...
        when 2112 => --0x840
          ...
          localRdData( 8)            <=  reg_data(2112)( 8);                          --sel memory
        when 2114 => --0x842
        ...
        when 2128 => --0x850
          ...
          localRdData( 8)            <=  reg_data(2128)( 8);                          --sel memory
        when 2130 => --0x852
        ...
        when 2144 => --0x860
          ...
          localRdData( 8)            <=  reg_data(2144)( 8);                          --sel memory
        when 2146 => --0x862
  ...
  Ctrl.PL_ST.PL_MEM(0).SIGNALS.mem_sel     <=  reg_data(2064)( 8);               
  ...
  Ctrl.PL_ST.PL_MEM(1).SIGNALS.mem_sel     <=  reg_data(2080)( 8);               
  ...
  Ctrl.PL_ST.PL_MEM(2).SIGNALS.mem_sel     <=  reg_data(2096)( 8);               
  ...
  Ctrl.PL_ST.PL_MEM(3).SIGNALS.mem_sel     <=  reg_data(2112)( 8);               
  ...
  Ctrl.PL_ST.PL_MEM(4).SIGNALS.mem_sel     <=  reg_data(2128)( 8);               
  ...
  Ctrl.PL_ST.PL_MEM(5).SIGNALS.mem_sel     <=  reg_data(2144)( 8);               
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      reg_data(2064)( 8)  <= DEFAULT_TAR_CTRL_t.PL_ST.PL_MEM(0).SIGNALS.mem_sel;
      ...
      reg_data(2080)( 8)  <= DEFAULT_TAR_CTRL_t.PL_ST.PL_MEM(1).SIGNALS.mem_sel;
      ...
      reg_data(2096)( 8)  <= DEFAULT_TAR_CTRL_t.PL_ST.PL_MEM(2).SIGNALS.mem_sel;
      ...
      reg_data(2112)( 8)  <= DEFAULT_TAR_CTRL_t.PL_ST.PL_MEM(3).SIGNALS.mem_sel;
      ...
      reg_data(2128)( 8)  <= DEFAULT_TAR_CTRL_t.PL_ST.PL_MEM(4).SIGNALS.mem_sel;
      ...
      reg_data(2144)( 8)  <= DEFAULT_TAR_CTRL_t.PL_ST.PL_MEM(5).SIGNALS.mem_sel;
      ...
      if localWrEn = '1' then
        ...
        when 2064 => --0x810
          ...
          reg_data(2064)( 8)                   <=  localWrData( 8);                --sel memory
        when 2066 => --0x812
        ...
        when 2080 => --0x820
          ...
          reg_data(2080)( 8)                   <=  localWrData( 8);                --sel memory
        when 2082 => --0x822
        ...
        when 2096 => --0x830
          ...
          reg_data(2096)( 8)                   <=  localWrData( 8);                --sel memory
        when 2098 => --0x832
        ...
        when 2112 => --0x840
          ...
          reg_data(2112)( 8)                   <=  localWrData( 8);                --sel memory
        when 2114 => --0x842
        ...
        when 2128 => --0x850
          ...
          reg_data(2128)( 8)                   <=  localWrData( 8);                --sel memory
        when 2130 => --0x852
        ...
        when 2144 => --0x860
          ...
          reg_data(2144)( 8)                   <=  localWrData( 8);                --sel memory
        when 2146 => --0x862
