...
package C2C_INTF_CTRL_DEF is
  constant Default_C2C_INTF_DRP_MOSI_t : C2C_INTF_DRP_MOSI_t := ( 
                                                     clk       => '0',
                                                     enable    => '0',
                                                     wr_enable => '0',
                                                     address   => (others => '0'),
  ...
  constant DEFAULT_C2C_INTF_STATUS_CTRL_t : C2C_INTF_STATUS_CTRL_t := (
                                                                       INITIALIZE => '0'
                                                                      );
  constant DEFAULT_C2C_INTF_DEBUG_RX_CTRL_t : C2C_INTF_DEBUG_RX_CTRL_t := (
                                                                           BUF_RESET => '0',
                                                                           CDR_HOLD => '0',
                                                                           DFE_LPM_RESET => '0',
                                                                           LPM_EN => '1',
  ...
  constant DEFAULT_C2C_INTF_DEBUG_TX_CTRL_t : C2C_INTF_DEBUG_TX_CTRL_t := (
                                                                           INHIBIT => '0',
                                                                           PCS_RESET => '0',
                                                                           PMA_RESET => '0',
                                                                           POLARITY => '0',
  ...
  constant DEFAULT_C2C_INTF_DEBUG_CTRL_t : C2C_INTF_DEBUG_CTRL_t := (
                                                                     EYESCAN_RESET => '0',
                                                                     EYESCAN_TRIGGER => '0',
  ...
  constant DEFAULT_C2C_INTF_COUNTERS_CTRL_t : C2C_INTF_COUNTERS_CTRL_t := (
                                                                           RESET_COUNTERS => '0'
                                                                          );
