...
begin  -- architecture behavioral
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      Ctrl.SUPER.CDE_CHAMB_Z0.CDE_CHAMB_Z0(0).SIGNALS.flush_req <= '0';
      ...
      Ctrl.SUPER.CDE_CHAMB_Z0.CDE_CHAMB_Z0(1).SIGNALS.flush_req <= '0';
      ...
      Ctrl.SUPER.CDE_CHAMB_Z0.CDE_CHAMB_Z0(2).SIGNALS.flush_req <= '0';
      ...
      Ctrl.SUPER.CDE_CHAMB_Z0.CDE_CHAMB_Z0(3).SIGNALS.flush_req <= '0';
      ...
      Ctrl.SUPER.CVP_CHAMB_Z0.CVP_CHAMB_Z0(0).SIGNALS.flush_req <= '0';
      ...
      Ctrl.SUPER.CVP_CHAMB_Z0.CVP_CHAMB_Z0(1).SIGNALS.flush_req <= '0';
      ...
      Ctrl.SUPER.CVP_CHAMB_Z0.CVP_CHAMB_Z0(2).SIGNALS.flush_req <= '0';
      ...
      Ctrl.SUPER.CVP_CHAMB_Z0.CVP_CHAMB_Z0(3).SIGNALS.flush_req <= '0';
      ...
      if localWrEn = '1' then
        ...
        when 48 => --0x30
          ...
          Ctrl.SUPER.CDE_CHAMB_Z0.CDE_CHAMB_Z0(0).SIGNALS.flush_req  <=  localWrData( 4);               
        when 50 => --0x32
        ...
        when 51 => --0x33
          ...
          Ctrl.SUPER.CDE_CHAMB_Z0.CDE_CHAMB_Z0(1).SIGNALS.flush_req  <=  localWrData( 4);               
        ...
        when 54 => --0x36
          ...
          Ctrl.SUPER.CDE_CHAMB_Z0.CDE_CHAMB_Z0(2).SIGNALS.flush_req  <=  localWrData( 4);               
        ...
        when 57 => --0x39
          ...
          Ctrl.SUPER.CDE_CHAMB_Z0.CDE_CHAMB_Z0(3).SIGNALS.flush_req  <=  localWrData( 4);               
        ...
        when 64 => --0x40
          ...
          Ctrl.SUPER.CVP_CHAMB_Z0.CVP_CHAMB_Z0(0).SIGNALS.flush_req  <=  localWrData( 4);               
        when 66 => --0x42
        ...
        when 67 => --0x43
          ...
          Ctrl.SUPER.CVP_CHAMB_Z0.CVP_CHAMB_Z0(1).SIGNALS.flush_req  <=  localWrData( 4);               
        ...
        when 70 => --0x46
          ...
          Ctrl.SUPER.CVP_CHAMB_Z0.CVP_CHAMB_Z0(2).SIGNALS.flush_req  <=  localWrData( 4);               
        ...
        when 73 => --0x49
          ...
          Ctrl.SUPER.CVP_CHAMB_Z0.CVP_CHAMB_Z0(3).SIGNALS.flush_req  <=  localWrData( 4);               
