  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      if localWrEn = '1' then
        ...
        when 261 => --0x105
          Ctrl.CDE_CHAMB_Z0.CDE_CHAMB_Z0(0).rd_req  <=  localWrData( 0);               
        when 262 => --0x106
        ...
        when 8465 => --0x2111
          Ctrl.CVP_CHAMB_Z0.CVP_CHAMB_Z0(2).rd_req  <=  localWrData( 0);               
        when 256 => --0x100
        ...
        when 273 => --0x111
          Ctrl.CVP_CHAMB_Z0.CVP_CHAMB_Z0(0).rd_req  <=  localWrData( 0);               
        when 274 => --0x112
        ...
        when 16645 => --0x4105
          Ctrl.CDE_CHAMB_Z0.CDE_CHAMB_Z0(3).rd_req  <=  localWrData( 0);               
        when 4356 => --0x1104
          Ctrl.CDE_CHAMB_Z0.CDE_CHAMB_Z0(1).wr_req  <=  localWrData( 0);               
        when 8453 => --0x2105
          Ctrl.CDE_CHAMB_Z0.CDE_CHAMB_Z0(2).rd_req  <=  localWrData( 0);               
        when 4358 => --0x1106
        ...
        when 4357 => --0x1105
          Ctrl.CDE_CHAMB_Z0.CDE_CHAMB_Z0(1).rd_req  <=  localWrData( 0);               
        when 8454 => --0x2106
        ...
        when 16657 => --0x4111
          Ctrl.CVP_CHAMB_Z0.CVP_CHAMB_Z0(3).rd_req  <=  localWrData( 0);               
        when 16646 => --0x4106
        ...
        when 4369 => --0x1111
          Ctrl.CVP_CHAMB_Z0.CVP_CHAMB_Z0(1).rd_req  <=  localWrData( 0);               
        when 4370 => --0x1112
