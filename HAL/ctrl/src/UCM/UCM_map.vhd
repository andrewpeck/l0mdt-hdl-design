    ...
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      if localWrEn = '1' then
        ...
        when 258 => --0x102
          ...
          Ctrl.CDE_CHAMB_Z0.CDE_CHAMB_Z0(0).WR.ADDR      <=  localWrData(23 downto 16);
          Ctrl.CDE_CHAMB_Z0.CDE_CHAMB_Z0(0).WR.WR_EN     <=  localWrData(24);
        when 4354 => --0x1102
          Ctrl.CDE_CHAMB_Z0.CDE_CHAMB_Z0(1).WR.ADDR      <=  localWrData(23 downto 16);
          Ctrl.CDE_CHAMB_Z0.CDE_CHAMB_Z0(1).WR.WR_EN     <=  localWrData(24);
          Ctrl.CDE_CHAMB_Z0.CDE_CHAMB_Z0(1).WR.VALUE  <=  localWrData(15 downto  0);     
        when 8450 => --0x2102
          Ctrl.CDE_CHAMB_Z0.CDE_CHAMB_Z0(2).WR.ADDR      <=  localWrData(23 downto 16);
          Ctrl.CDE_CHAMB_Z0.CDE_CHAMB_Z0(2).WR.WR_EN     <=  localWrData(24);
          Ctrl.CDE_CHAMB_Z0.CDE_CHAMB_Z0(2).WR.VALUE  <=  localWrData(15 downto  0);     
        when 16642 => --0x4102
          Ctrl.CDE_CHAMB_Z0.CDE_CHAMB_Z0(3).WR.ADDR      <=  localWrData(23 downto 16);
          Ctrl.CDE_CHAMB_Z0.CDE_CHAMB_Z0(3).WR.WR_EN     <=  localWrData(24);
        ...
        when 262 => --0x106
          ...
          Ctrl.CVP_CHAMB_Z0.CVP_CHAMB_Z0(0).WR.ADDR      <=  localWrData(23 downto 16);
          Ctrl.CVP_CHAMB_Z0.CVP_CHAMB_Z0(0).WR.WR_EN     <=  localWrData(24);
        when 4358 => --0x1106
          Ctrl.CVP_CHAMB_Z0.CVP_CHAMB_Z0(1).WR.ADDR      <=  localWrData(23 downto 16);
          Ctrl.CVP_CHAMB_Z0.CVP_CHAMB_Z0(1).WR.WR_EN     <=  localWrData(24);
          Ctrl.CVP_CHAMB_Z0.CVP_CHAMB_Z0(1).WR.VALUE  <=  localWrData(15 downto  0);     
        when 8454 => --0x2106
          Ctrl.CVP_CHAMB_Z0.CVP_CHAMB_Z0(2).WR.ADDR      <=  localWrData(23 downto 16);
          Ctrl.CVP_CHAMB_Z0.CVP_CHAMB_Z0(2).WR.WR_EN     <=  localWrData(24);
          Ctrl.CVP_CHAMB_Z0.CVP_CHAMB_Z0(2).WR.VALUE  <=  localWrData(15 downto  0);     
        when 16646 => --0x4106
          Ctrl.CVP_CHAMB_Z0.CVP_CHAMB_Z0(3).WR.ADDR      <=  localWrData(23 downto 16);
          Ctrl.CVP_CHAMB_Z0.CVP_CHAMB_Z0(3).WR.WR_EN     <=  localWrData(24);
