...
package UCM_PKG;
   ...
   typedef UCM_SUPER_CDE_CHAMB_Z0_CDE_CHAMB_Z0_MON_t UCM_SUPER_CDE_CHAMB_Z0_CDE_CHAMB_Z0_MON_t_ARRAY[4-1:0];
   ...
   typedef UCM_SUPER_CDE_CHAMB_Z0_CDE_CHAMB_Z0_CTRL_t UCM_SUPER_CDE_CHAMB_Z0_CDE_CHAMB_Z0_CTRL_t_ARRAY[4-1:0];
   ...
   typedef UCM_SUPER_CVP_CHAMB_Z0_CVP_CHAMB_Z0_MON_t UCM_SUPER_CVP_CHAMB_Z0_CVP_CHAMB_Z0_MON_t_ARRAY[4-1:0];
   ...
   typedef UCM_SUPER_CVP_CHAMB_Z0_CVP_CHAMB_Z0_CTRL_t UCM_SUPER_CVP_CHAMB_Z0_CVP_CHAMB_Z0_CTRL_t_ARRAY[4-1:0];
   ...
   typedef struct UCM_R_PHI_COMP_RPC_CTRL_t {
      logic sel_thread[4-1:0];
      logic sel_station[4-1:0];
      logic sel_layer[4-1:0];
      logic ext_ctrl;
