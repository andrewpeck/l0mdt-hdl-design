...
begin  -- architecture behavioral
  ...
  -------------------------------------------------------------------------------
  -------------------------------------------------------------------------------
  assert ((4*2312) <= ALLOCATED_MEMORY_RANGE)
    report "HAL: Regmap addressing range " & integer'image(4*2312) & " is outside of AXI mapped range " & integer'image(ALLOCATED_MEMORY_RANGE)
  severity ERROR;
  assert ((4*2312) > ALLOCATED_MEMORY_RANGE)
    report "HAL: Regmap addressing range " & integer'image(4*2312) & " is inside of AXI mapped range " & integer'image(ALLOCATED_MEMORY_RANGE)
  severity NOTE;
  ...
  begin  -- process latch_reads
    if reset_axi_n = '0' then
      ...
      if localRdReq = '1' then
        ...
        when 48 => --0x30
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(0).CONFIG.master_link_id;                    --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(0).CONFIG.servant_link_id;                   --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(0).CONFIG.station;                           --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(0).CONFIG.polmux;                            --
        ...
        when 49 => --0x31
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(0).CONFIG.en;                                --
        ...
        when 50 => --0x32
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(0).CONFIG.legacy;                            --
        when 51 => --0x33
        ...
        when 112 => --0x70
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(1).CONFIG.master_link_id;                    --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(1).CONFIG.servant_link_id;                   --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(1).CONFIG.station;                           --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(1).CONFIG.polmux;                            --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(1).SC.MASTER.SCA_RX.RX(1).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 113 => --0x71
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(1).CONFIG.en;                                --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(1).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;        --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 114 => --0x72
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(1).CONFIG.legacy;                            --
        when 115 => --0x73
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(1).SC.MASTER.SCA_RX.RX(2).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 117 => --0x75
        ...
        when 176 => --0xb0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(2).CONFIG.master_link_id;                    --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(2).CONFIG.servant_link_id;                   --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(2).CONFIG.station;                           --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(2).CONFIG.polmux;                            --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(2).SC.MASTER.SCA_RX.RX(1).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 177 => --0xb1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(2).CONFIG.en;                                --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(2).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;        --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 178 => --0xb2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(2).CONFIG.legacy;                            --
        when 179 => --0xb3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(2).SC.MASTER.SCA_RX.RX(2).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 181 => --0xb5
        ...
        when 240 => --0xf0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(3).CONFIG.master_link_id;                    --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(3).CONFIG.servant_link_id;                   --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(3).CONFIG.station;                           --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(3).CONFIG.polmux;                            --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(3).SC.MASTER.SCA_RX.RX(1).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 241 => --0xf1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(3).CONFIG.en;                                --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(3).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;        --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 242 => --0xf2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(3).CONFIG.legacy;                            --
        when 243 => --0xf3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(3).SC.MASTER.SCA_RX.RX(2).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 245 => --0xf5
        ...
        when 304 => --0x130
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(4).CONFIG.master_link_id;                    --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(4).CONFIG.servant_link_id;                   --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(4).CONFIG.station;                           --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(4).CONFIG.polmux;                            --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(4).SC.MASTER.SCA_RX.RX(1).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 305 => --0x131
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(4).CONFIG.en;                                --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(4).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;        --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 306 => --0x132
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(4).CONFIG.legacy;                            --
        when 307 => --0x133
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(4).SC.MASTER.SCA_RX.RX(2).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 309 => --0x135
        ...
        when 368 => --0x170
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(5).CONFIG.master_link_id;                    --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(5).CONFIG.servant_link_id;                   --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(5).CONFIG.station;                           --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(5).CONFIG.polmux;                            --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(5).SC.MASTER.SCA_RX.RX(1).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 369 => --0x171
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(5).CONFIG.en;                                --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(5).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;        --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 370 => --0x172
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(5).CONFIG.legacy;                            --
        when 371 => --0x173
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(5).SC.MASTER.SCA_RX.RX(2).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 373 => --0x175
        ...
        when 432 => --0x1b0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(6).CONFIG.master_link_id;                    --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(6).CONFIG.servant_link_id;                   --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(6).CONFIG.station;                           --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(6).CONFIG.polmux;                            --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(6).SC.MASTER.SCA_RX.RX(1).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 433 => --0x1b1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(6).CONFIG.en;                                --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(6).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;        --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 434 => --0x1b2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(6).CONFIG.legacy;                            --
        when 435 => --0x1b3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(6).SC.MASTER.SCA_RX.RX(2).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 437 => --0x1b5
        ...
        when 496 => --0x1f0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(7).CONFIG.master_link_id;                    --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(7).CONFIG.servant_link_id;                   --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(7).CONFIG.station;                           --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(7).CONFIG.polmux;                            --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(7).SC.MASTER.SCA_RX.RX(1).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 497 => --0x1f1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(7).CONFIG.en;                                --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(7).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;        --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 498 => --0x1f2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(7).CONFIG.legacy;                            --
        when 499 => --0x1f3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(7).SC.MASTER.SCA_RX.RX(2).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 501 => --0x1f5
        ...
        when 560 => --0x230
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(8).CONFIG.master_link_id;                    --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(8).CONFIG.servant_link_id;                   --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(8).CONFIG.station;                           --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(8).CONFIG.polmux;                            --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(8).SC.MASTER.SCA_RX.RX(1).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 561 => --0x231
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(8).CONFIG.en;                                --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(8).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;        --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 562 => --0x232
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(8).CONFIG.legacy;                            --
        when 563 => --0x233
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(8).SC.MASTER.SCA_RX.RX(2).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 565 => --0x235
        ...
        when 624 => --0x270
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(9).CONFIG.master_link_id;                    --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(9).CONFIG.servant_link_id;                   --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(9).CONFIG.station;                           --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(9).CONFIG.polmux;                            --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(9).SC.MASTER.SCA_RX.RX(1).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 625 => --0x271
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(9).CONFIG.en;                                --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(9).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;        --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 626 => --0x272
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(9).CONFIG.legacy;                            --
        when 627 => --0x273
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(9).SC.MASTER.SCA_RX.RX(2).RX_DATA;           --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 629 => --0x275
        ...
        when 688 => --0x2b0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(10).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(10).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(10).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(10).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(10).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 689 => --0x2b1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(10).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(10).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 690 => --0x2b2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(10).CONFIG.legacy;                           --
        when 691 => --0x2b3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(10).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 693 => --0x2b5
        ...
        when 752 => --0x2f0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(11).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(11).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(11).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(11).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(11).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 753 => --0x2f1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(11).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(11).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 754 => --0x2f2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(11).CONFIG.legacy;                           --
        when 755 => --0x2f3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(11).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 757 => --0x2f5
        ...
        when 816 => --0x330
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(12).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(12).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(12).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(12).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(12).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 817 => --0x331
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(12).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(12).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 818 => --0x332
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(12).CONFIG.legacy;                           --
        when 819 => --0x333
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(12).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 821 => --0x335
        ...
        when 880 => --0x370
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(13).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(13).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(13).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(13).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(13).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 881 => --0x371
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(13).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(13).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 882 => --0x372
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(13).CONFIG.legacy;                           --
        when 883 => --0x373
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(13).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 885 => --0x375
        ...
        when 944 => --0x3b0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(14).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(14).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(14).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(14).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(14).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 945 => --0x3b1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(14).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(14).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 946 => --0x3b2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(14).CONFIG.legacy;                           --
        when 947 => --0x3b3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(14).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 949 => --0x3b5
        ...
        when 1008 => --0x3f0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(15).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(15).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(15).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(15).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(15).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1009 => --0x3f1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(15).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(15).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 1010 => --0x3f2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(15).CONFIG.legacy;                           --
        when 1011 => --0x3f3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(15).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1013 => --0x3f5
        ...
        when 1072 => --0x430
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(16).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(16).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(16).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(16).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(16).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1073 => --0x431
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(16).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(16).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 1074 => --0x432
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(16).CONFIG.legacy;                           --
        when 1075 => --0x433
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(16).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1077 => --0x435
        ...
        when 1136 => --0x470
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(17).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(17).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(17).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(17).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(17).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1137 => --0x471
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(17).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(17).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 1138 => --0x472
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(17).CONFIG.legacy;                           --
        when 1139 => --0x473
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(17).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1141 => --0x475
        ...
        when 1200 => --0x4b0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(18).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(18).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(18).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(18).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(18).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1201 => --0x4b1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(18).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(18).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 1202 => --0x4b2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(18).CONFIG.legacy;                           --
        when 1203 => --0x4b3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(18).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1205 => --0x4b5
        ...
        when 1264 => --0x4f0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(19).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(19).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(19).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(19).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(19).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1265 => --0x4f1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(19).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(19).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 1266 => --0x4f2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(19).CONFIG.legacy;                           --
        when 1267 => --0x4f3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(19).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1269 => --0x4f5
        ...
        when 1328 => --0x530
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(20).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(20).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(20).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(20).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(20).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1329 => --0x531
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(20).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(20).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 1330 => --0x532
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(20).CONFIG.legacy;                           --
        when 1331 => --0x533
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(20).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1333 => --0x535
        ...
        when 1392 => --0x570
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(21).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(21).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(21).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(21).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(21).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1393 => --0x571
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(21).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(21).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 1394 => --0x572
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(21).CONFIG.legacy;                           --
        when 1395 => --0x573
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(21).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1397 => --0x575
        ...
        when 1456 => --0x5b0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(22).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(22).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(22).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(22).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(22).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1457 => --0x5b1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(22).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(22).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 1458 => --0x5b2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(22).CONFIG.legacy;                           --
        when 1459 => --0x5b3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(22).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1461 => --0x5b5
        ...
        when 1520 => --0x5f0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(23).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(23).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(23).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(23).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(23).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1521 => --0x5f1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(23).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(23).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 1522 => --0x5f2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(23).CONFIG.legacy;                           --
        when 1523 => --0x5f3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(23).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1525 => --0x5f5
        ...
        when 1584 => --0x630
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(24).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(24).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(24).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(24).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(24).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1585 => --0x631
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(24).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(24).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 1586 => --0x632
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(24).CONFIG.legacy;                           --
        when 1587 => --0x633
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(24).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1589 => --0x635
        ...
        when 1648 => --0x670
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(25).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(25).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(25).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(25).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(25).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1649 => --0x671
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(25).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(25).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 1650 => --0x672
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(25).CONFIG.legacy;                           --
        when 1651 => --0x673
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(25).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1653 => --0x675
        ...
        when 1712 => --0x6b0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(26).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(26).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(26).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(26).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(26).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1713 => --0x6b1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(26).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(26).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 1714 => --0x6b2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(26).CONFIG.legacy;                           --
        when 1715 => --0x6b3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(26).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1717 => --0x6b5
        ...
        when 1776 => --0x6f0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(27).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(27).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(27).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(27).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(27).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1777 => --0x6f1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(27).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(27).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 1778 => --0x6f2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(27).CONFIG.legacy;                           --
        when 1779 => --0x6f3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(27).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1781 => --0x6f5
        ...
        when 1840 => --0x730
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(28).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(28).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(28).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(28).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(28).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1841 => --0x731
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(28).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(28).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 1842 => --0x732
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(28).CONFIG.legacy;                           --
        when 1843 => --0x733
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(28).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1845 => --0x735
        ...
        when 1904 => --0x770
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(29).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(29).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(29).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(29).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(29).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1905 => --0x771
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(29).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(29).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 1906 => --0x772
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(29).CONFIG.legacy;                           --
        when 1907 => --0x773
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(29).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1909 => --0x775
        ...
        when 1968 => --0x7b0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(30).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(30).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(30).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(30).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(30).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1969 => --0x7b1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(30).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(30).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 1970 => --0x7b2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(30).CONFIG.legacy;                           --
        when 1971 => --0x7b3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(30).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 1973 => --0x7b5
        ...
        when 2032 => --0x7f0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(31).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(31).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(31).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(31).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(31).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 2033 => --0x7f1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(31).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(31).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 2034 => --0x7f2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(31).CONFIG.legacy;                           --
        when 2035 => --0x7f3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(31).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 2037 => --0x7f5
        ...
        when 2096 => --0x830
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(32).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(32).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(32).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(32).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(32).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 2097 => --0x831
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(32).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(32).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 2098 => --0x832
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(32).CONFIG.legacy;                           --
        when 2099 => --0x833
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(32).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 2101 => --0x835
        ...
        when 2160 => --0x870
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(33).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(33).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(33).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(33).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(33).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 2161 => --0x871
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(33).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(33).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 2162 => --0x872
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(33).CONFIG.legacy;                           --
        when 2163 => --0x873
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(33).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 2165 => --0x875
        ...
        when 2224 => --0x8b0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(34).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(34).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(34).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(34).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(34).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 2225 => --0x8b1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(34).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(34).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 2226 => --0x8b2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(34).CONFIG.legacy;                           --
        when 2227 => --0x8b3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(34).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 2229 => --0x8b5
        ...
        when 2288 => --0x8f0
          localRdData( 5 downto  0)  <=  Mon.CSM.CSM(35).CONFIG.master_link_id;                   --
          localRdData(12 downto  7)  <=  Mon.CSM.CSM(35).CONFIG.servant_link_id;                  --
          localRdData(15 downto 13)  <=  Mon.CSM.CSM(35).CONFIG.station;                          --
          localRdData(21 downto 16)  <=  Mon.CSM.CSM(35).CONFIG.polmux;                           --
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(35).SC.MASTER.SCA_RX.RX(1).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 2289 => --0x8f1
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(35).CONFIG.en;                               --
          localRdData(23 downto 16)  <=  Mon.CSM.CSM(35).SC.MASTER.SCA_RX.RX(2).RX_CONTROL;       --Reply: The control field is 1 byte in length and contains frame sequence numbers of the currently transmitted frame and the last correctly received frame. The control field is also used to convey three supervisory level commands: Connect, Reset, and Test.
        ...
        when 2290 => --0x8f2
          ...
          localRdData(19 downto  0)  <=  Mon.CSM.CSM(35).CONFIG.legacy;                           --
        when 2291 => --0x8f3
          localRdData(31 downto  0)  <=  Mon.CSM.CSM(35).SC.MASTER.SCA_RX.RX(2).RX_DATA;          --Reply: The Data field is command dependent field whose length is defined by the length qualifier field. For example, in the case of a read/write operation on a GBT-SCA internal register, it contains the value written/read from the register.
        when 2293 => --0x8f5
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      reg_data(21)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(0).LPGBT.UPLINK.UPLINK(1).RESET;
      ...
      reg_data(80)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(1).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(85)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(1).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(91)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(1).LPGBT.DOWNLINK.RESET;
      reg_data(96)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(1).SC.MASTER.TX_RESET;
      reg_data(97)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(1).SC.MASTER.RX_RESET;
      ...
      reg_data(101)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(1).SC.MASTER.IC.TX_WR;
      ...
      reg_data(118)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(1).SC.MASTER.START_RESET;
      reg_data(119)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(1).SC.MASTER.START_CONNECT;
      reg_data(120)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(1).SC.MASTER.START_COMMAND;
      reg_data(121)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(1).SC.MASTER.INJ_CRC_ERR;
      reg_data(128)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(1).SC.SLAVE.TX_RESET;
      reg_data(129)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(1).SC.SLAVE.RX_RESET;
      ...
      reg_data(133)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(1).SC.SLAVE.IC.TX_WR;
      reg_data(144)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(2).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(149)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(2).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(155)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(2).LPGBT.DOWNLINK.RESET;
      reg_data(160)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(2).SC.MASTER.TX_RESET;
      reg_data(161)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(2).SC.MASTER.RX_RESET;
      ...
      reg_data(165)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(2).SC.MASTER.IC.TX_WR;
      ...
      reg_data(182)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(2).SC.MASTER.START_RESET;
      reg_data(183)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(2).SC.MASTER.START_CONNECT;
      reg_data(184)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(2).SC.MASTER.START_COMMAND;
      reg_data(185)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(2).SC.MASTER.INJ_CRC_ERR;
      reg_data(192)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(2).SC.SLAVE.TX_RESET;
      reg_data(193)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(2).SC.SLAVE.RX_RESET;
      ...
      reg_data(197)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(2).SC.SLAVE.IC.TX_WR;
      reg_data(208)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(3).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(213)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(3).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(219)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(3).LPGBT.DOWNLINK.RESET;
      reg_data(224)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(3).SC.MASTER.TX_RESET;
      reg_data(225)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(3).SC.MASTER.RX_RESET;
      ...
      reg_data(229)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(3).SC.MASTER.IC.TX_WR;
      ...
      reg_data(246)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(3).SC.MASTER.START_RESET;
      reg_data(247)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(3).SC.MASTER.START_CONNECT;
      reg_data(248)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(3).SC.MASTER.START_COMMAND;
      reg_data(249)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(3).SC.MASTER.INJ_CRC_ERR;
      reg_data(256)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(3).SC.SLAVE.TX_RESET;
      reg_data(257)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(3).SC.SLAVE.RX_RESET;
      ...
      reg_data(261)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(3).SC.SLAVE.IC.TX_WR;
      reg_data(272)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(4).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(277)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(4).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(283)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(4).LPGBT.DOWNLINK.RESET;
      reg_data(288)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(4).SC.MASTER.TX_RESET;
      reg_data(289)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(4).SC.MASTER.RX_RESET;
      ...
      reg_data(293)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(4).SC.MASTER.IC.TX_WR;
      ...
      reg_data(310)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(4).SC.MASTER.START_RESET;
      reg_data(311)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(4).SC.MASTER.START_CONNECT;
      reg_data(312)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(4).SC.MASTER.START_COMMAND;
      reg_data(313)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(4).SC.MASTER.INJ_CRC_ERR;
      reg_data(320)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(4).SC.SLAVE.TX_RESET;
      reg_data(321)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(4).SC.SLAVE.RX_RESET;
      ...
      reg_data(325)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(4).SC.SLAVE.IC.TX_WR;
      reg_data(336)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(5).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(341)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(5).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(347)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(5).LPGBT.DOWNLINK.RESET;
      reg_data(352)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(5).SC.MASTER.TX_RESET;
      reg_data(353)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(5).SC.MASTER.RX_RESET;
      ...
      reg_data(357)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(5).SC.MASTER.IC.TX_WR;
      ...
      reg_data(374)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(5).SC.MASTER.START_RESET;
      reg_data(375)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(5).SC.MASTER.START_CONNECT;
      reg_data(376)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(5).SC.MASTER.START_COMMAND;
      reg_data(377)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(5).SC.MASTER.INJ_CRC_ERR;
      reg_data(384)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(5).SC.SLAVE.TX_RESET;
      reg_data(385)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(5).SC.SLAVE.RX_RESET;
      ...
      reg_data(389)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(5).SC.SLAVE.IC.TX_WR;
      reg_data(400)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(6).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(405)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(6).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(411)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(6).LPGBT.DOWNLINK.RESET;
      reg_data(416)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(6).SC.MASTER.TX_RESET;
      reg_data(417)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(6).SC.MASTER.RX_RESET;
      ...
      reg_data(421)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(6).SC.MASTER.IC.TX_WR;
      ...
      reg_data(438)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(6).SC.MASTER.START_RESET;
      reg_data(439)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(6).SC.MASTER.START_CONNECT;
      reg_data(440)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(6).SC.MASTER.START_COMMAND;
      reg_data(441)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(6).SC.MASTER.INJ_CRC_ERR;
      reg_data(448)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(6).SC.SLAVE.TX_RESET;
      reg_data(449)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(6).SC.SLAVE.RX_RESET;
      ...
      reg_data(453)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(6).SC.SLAVE.IC.TX_WR;
      reg_data(464)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(7).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(469)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(7).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(475)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(7).LPGBT.DOWNLINK.RESET;
      reg_data(480)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(7).SC.MASTER.TX_RESET;
      reg_data(481)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(7).SC.MASTER.RX_RESET;
      ...
      reg_data(485)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(7).SC.MASTER.IC.TX_WR;
      ...
      reg_data(502)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(7).SC.MASTER.START_RESET;
      reg_data(503)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(7).SC.MASTER.START_CONNECT;
      reg_data(504)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(7).SC.MASTER.START_COMMAND;
      reg_data(505)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(7).SC.MASTER.INJ_CRC_ERR;
      reg_data(512)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(7).SC.SLAVE.TX_RESET;
      reg_data(513)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(7).SC.SLAVE.RX_RESET;
      ...
      reg_data(517)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(7).SC.SLAVE.IC.TX_WR;
      reg_data(528)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(8).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(533)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(8).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(539)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(8).LPGBT.DOWNLINK.RESET;
      reg_data(544)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(8).SC.MASTER.TX_RESET;
      reg_data(545)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(8).SC.MASTER.RX_RESET;
      ...
      reg_data(549)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(8).SC.MASTER.IC.TX_WR;
      ...
      reg_data(566)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(8).SC.MASTER.START_RESET;
      reg_data(567)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(8).SC.MASTER.START_CONNECT;
      reg_data(568)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(8).SC.MASTER.START_COMMAND;
      reg_data(569)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(8).SC.MASTER.INJ_CRC_ERR;
      reg_data(576)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(8).SC.SLAVE.TX_RESET;
      reg_data(577)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(8).SC.SLAVE.RX_RESET;
      ...
      reg_data(581)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(8).SC.SLAVE.IC.TX_WR;
      reg_data(592)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(9).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(597)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(9).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(603)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(9).LPGBT.DOWNLINK.RESET;
      reg_data(608)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(9).SC.MASTER.TX_RESET;
      reg_data(609)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(9).SC.MASTER.RX_RESET;
      ...
      reg_data(613)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(9).SC.MASTER.IC.TX_WR;
      ...
      reg_data(630)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(9).SC.MASTER.START_RESET;
      reg_data(631)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(9).SC.MASTER.START_CONNECT;
      reg_data(632)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(9).SC.MASTER.START_COMMAND;
      reg_data(633)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(9).SC.MASTER.INJ_CRC_ERR;
      reg_data(640)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(9).SC.SLAVE.TX_RESET;
      reg_data(641)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(9).SC.SLAVE.RX_RESET;
      ...
      reg_data(645)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(9).SC.SLAVE.IC.TX_WR;
      reg_data(656)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(10).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(661)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(10).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(667)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(10).LPGBT.DOWNLINK.RESET;
      reg_data(672)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(10).SC.MASTER.TX_RESET;
      reg_data(673)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(10).SC.MASTER.RX_RESET;
      ...
      reg_data(677)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(10).SC.MASTER.IC.TX_WR;
      ...
      reg_data(694)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(10).SC.MASTER.START_RESET;
      reg_data(695)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(10).SC.MASTER.START_CONNECT;
      reg_data(696)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(10).SC.MASTER.START_COMMAND;
      reg_data(697)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(10).SC.MASTER.INJ_CRC_ERR;
      reg_data(704)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(10).SC.SLAVE.TX_RESET;
      reg_data(705)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(10).SC.SLAVE.RX_RESET;
      ...
      reg_data(709)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(10).SC.SLAVE.IC.TX_WR;
      reg_data(720)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(11).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(725)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(11).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(731)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(11).LPGBT.DOWNLINK.RESET;
      reg_data(736)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(11).SC.MASTER.TX_RESET;
      reg_data(737)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(11).SC.MASTER.RX_RESET;
      ...
      reg_data(741)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(11).SC.MASTER.IC.TX_WR;
      ...
      reg_data(758)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(11).SC.MASTER.START_RESET;
      reg_data(759)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(11).SC.MASTER.START_CONNECT;
      reg_data(760)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(11).SC.MASTER.START_COMMAND;
      reg_data(761)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(11).SC.MASTER.INJ_CRC_ERR;
      reg_data(768)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(11).SC.SLAVE.TX_RESET;
      reg_data(769)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(11).SC.SLAVE.RX_RESET;
      ...
      reg_data(773)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(11).SC.SLAVE.IC.TX_WR;
      reg_data(784)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(12).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(789)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(12).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(795)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(12).LPGBT.DOWNLINK.RESET;
      reg_data(800)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(12).SC.MASTER.TX_RESET;
      reg_data(801)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(12).SC.MASTER.RX_RESET;
      ...
      reg_data(805)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(12).SC.MASTER.IC.TX_WR;
      ...
      reg_data(822)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(12).SC.MASTER.START_RESET;
      reg_data(823)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(12).SC.MASTER.START_CONNECT;
      reg_data(824)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(12).SC.MASTER.START_COMMAND;
      reg_data(825)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(12).SC.MASTER.INJ_CRC_ERR;
      reg_data(832)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(12).SC.SLAVE.TX_RESET;
      reg_data(833)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(12).SC.SLAVE.RX_RESET;
      ...
      reg_data(837)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(12).SC.SLAVE.IC.TX_WR;
      reg_data(848)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(13).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(853)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(13).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(859)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(13).LPGBT.DOWNLINK.RESET;
      reg_data(864)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(13).SC.MASTER.TX_RESET;
      reg_data(865)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(13).SC.MASTER.RX_RESET;
      ...
      reg_data(869)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(13).SC.MASTER.IC.TX_WR;
      ...
      reg_data(886)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(13).SC.MASTER.START_RESET;
      reg_data(887)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(13).SC.MASTER.START_CONNECT;
      reg_data(888)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(13).SC.MASTER.START_COMMAND;
      reg_data(889)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(13).SC.MASTER.INJ_CRC_ERR;
      reg_data(896)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(13).SC.SLAVE.TX_RESET;
      reg_data(897)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(13).SC.SLAVE.RX_RESET;
      ...
      reg_data(901)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(13).SC.SLAVE.IC.TX_WR;
      reg_data(912)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(14).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(917)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(14).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(923)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(14).LPGBT.DOWNLINK.RESET;
      reg_data(928)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(14).SC.MASTER.TX_RESET;
      reg_data(929)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(14).SC.MASTER.RX_RESET;
      ...
      reg_data(933)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(14).SC.MASTER.IC.TX_WR;
      ...
      reg_data(950)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(14).SC.MASTER.START_RESET;
      reg_data(951)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(14).SC.MASTER.START_CONNECT;
      reg_data(952)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(14).SC.MASTER.START_COMMAND;
      reg_data(953)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(14).SC.MASTER.INJ_CRC_ERR;
      reg_data(960)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(14).SC.SLAVE.TX_RESET;
      reg_data(961)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(14).SC.SLAVE.RX_RESET;
      ...
      reg_data(965)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(14).SC.SLAVE.IC.TX_WR;
      reg_data(976)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(15).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(981)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(15).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(987)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(15).LPGBT.DOWNLINK.RESET;
      reg_data(992)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(15).SC.MASTER.TX_RESET;
      reg_data(993)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(15).SC.MASTER.RX_RESET;
      ...
      reg_data(997)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(15).SC.MASTER.IC.TX_WR;
      ...
      reg_data(1014)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(15).SC.MASTER.START_RESET;
      reg_data(1015)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(15).SC.MASTER.START_CONNECT;
      reg_data(1016)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(15).SC.MASTER.START_COMMAND;
      reg_data(1017)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(15).SC.MASTER.INJ_CRC_ERR;
      reg_data(1024)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(15).SC.SLAVE.TX_RESET;
      reg_data(1025)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(15).SC.SLAVE.RX_RESET;
      ...
      reg_data(1029)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(15).SC.SLAVE.IC.TX_WR;
      reg_data(1040)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(16).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(1045)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(16).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(1051)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(16).LPGBT.DOWNLINK.RESET;
      reg_data(1056)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(16).SC.MASTER.TX_RESET;
      reg_data(1057)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(16).SC.MASTER.RX_RESET;
      ...
      reg_data(1061)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(16).SC.MASTER.IC.TX_WR;
      ...
      reg_data(1078)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(16).SC.MASTER.START_RESET;
      reg_data(1079)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(16).SC.MASTER.START_CONNECT;
      reg_data(1080)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(16).SC.MASTER.START_COMMAND;
      reg_data(1081)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(16).SC.MASTER.INJ_CRC_ERR;
      reg_data(1088)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(16).SC.SLAVE.TX_RESET;
      reg_data(1089)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(16).SC.SLAVE.RX_RESET;
      ...
      reg_data(1093)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(16).SC.SLAVE.IC.TX_WR;
      reg_data(1104)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(17).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(1109)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(17).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(1115)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(17).LPGBT.DOWNLINK.RESET;
      reg_data(1120)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(17).SC.MASTER.TX_RESET;
      reg_data(1121)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(17).SC.MASTER.RX_RESET;
      ...
      reg_data(1125)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(17).SC.MASTER.IC.TX_WR;
      ...
      reg_data(1142)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(17).SC.MASTER.START_RESET;
      reg_data(1143)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(17).SC.MASTER.START_CONNECT;
      reg_data(1144)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(17).SC.MASTER.START_COMMAND;
      reg_data(1145)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(17).SC.MASTER.INJ_CRC_ERR;
      reg_data(1152)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(17).SC.SLAVE.TX_RESET;
      reg_data(1153)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(17).SC.SLAVE.RX_RESET;
      ...
      reg_data(1157)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(17).SC.SLAVE.IC.TX_WR;
      reg_data(1168)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(18).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(1173)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(18).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(1179)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(18).LPGBT.DOWNLINK.RESET;
      reg_data(1184)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(18).SC.MASTER.TX_RESET;
      reg_data(1185)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(18).SC.MASTER.RX_RESET;
      ...
      reg_data(1189)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(18).SC.MASTER.IC.TX_WR;
      ...
      reg_data(1206)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(18).SC.MASTER.START_RESET;
      reg_data(1207)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(18).SC.MASTER.START_CONNECT;
      reg_data(1208)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(18).SC.MASTER.START_COMMAND;
      reg_data(1209)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(18).SC.MASTER.INJ_CRC_ERR;
      reg_data(1216)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(18).SC.SLAVE.TX_RESET;
      reg_data(1217)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(18).SC.SLAVE.RX_RESET;
      ...
      reg_data(1221)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(18).SC.SLAVE.IC.TX_WR;
      reg_data(1232)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(19).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(1237)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(19).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(1243)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(19).LPGBT.DOWNLINK.RESET;
      reg_data(1248)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(19).SC.MASTER.TX_RESET;
      reg_data(1249)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(19).SC.MASTER.RX_RESET;
      ...
      reg_data(1253)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(19).SC.MASTER.IC.TX_WR;
      ...
      reg_data(1270)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(19).SC.MASTER.START_RESET;
      reg_data(1271)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(19).SC.MASTER.START_CONNECT;
      reg_data(1272)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(19).SC.MASTER.START_COMMAND;
      reg_data(1273)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(19).SC.MASTER.INJ_CRC_ERR;
      reg_data(1280)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(19).SC.SLAVE.TX_RESET;
      reg_data(1281)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(19).SC.SLAVE.RX_RESET;
      ...
      reg_data(1285)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(19).SC.SLAVE.IC.TX_WR;
      reg_data(1296)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(20).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(1301)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(20).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(1307)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(20).LPGBT.DOWNLINK.RESET;
      reg_data(1312)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(20).SC.MASTER.TX_RESET;
      reg_data(1313)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(20).SC.MASTER.RX_RESET;
      ...
      reg_data(1317)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(20).SC.MASTER.IC.TX_WR;
      ...
      reg_data(1334)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(20).SC.MASTER.START_RESET;
      reg_data(1335)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(20).SC.MASTER.START_CONNECT;
      reg_data(1336)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(20).SC.MASTER.START_COMMAND;
      reg_data(1337)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(20).SC.MASTER.INJ_CRC_ERR;
      reg_data(1344)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(20).SC.SLAVE.TX_RESET;
      reg_data(1345)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(20).SC.SLAVE.RX_RESET;
      ...
      reg_data(1349)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(20).SC.SLAVE.IC.TX_WR;
      reg_data(1360)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(21).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(1365)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(21).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(1371)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(21).LPGBT.DOWNLINK.RESET;
      reg_data(1376)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(21).SC.MASTER.TX_RESET;
      reg_data(1377)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(21).SC.MASTER.RX_RESET;
      ...
      reg_data(1381)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(21).SC.MASTER.IC.TX_WR;
      ...
      reg_data(1398)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(21).SC.MASTER.START_RESET;
      reg_data(1399)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(21).SC.MASTER.START_CONNECT;
      reg_data(1400)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(21).SC.MASTER.START_COMMAND;
      reg_data(1401)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(21).SC.MASTER.INJ_CRC_ERR;
      reg_data(1408)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(21).SC.SLAVE.TX_RESET;
      reg_data(1409)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(21).SC.SLAVE.RX_RESET;
      ...
      reg_data(1413)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(21).SC.SLAVE.IC.TX_WR;
      reg_data(1424)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(22).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(1429)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(22).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(1435)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(22).LPGBT.DOWNLINK.RESET;
      reg_data(1440)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(22).SC.MASTER.TX_RESET;
      reg_data(1441)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(22).SC.MASTER.RX_RESET;
      ...
      reg_data(1445)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(22).SC.MASTER.IC.TX_WR;
      ...
      reg_data(1462)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(22).SC.MASTER.START_RESET;
      reg_data(1463)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(22).SC.MASTER.START_CONNECT;
      reg_data(1464)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(22).SC.MASTER.START_COMMAND;
      reg_data(1465)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(22).SC.MASTER.INJ_CRC_ERR;
      reg_data(1472)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(22).SC.SLAVE.TX_RESET;
      reg_data(1473)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(22).SC.SLAVE.RX_RESET;
      ...
      reg_data(1477)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(22).SC.SLAVE.IC.TX_WR;
      reg_data(1488)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(23).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(1493)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(23).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(1499)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(23).LPGBT.DOWNLINK.RESET;
      reg_data(1504)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(23).SC.MASTER.TX_RESET;
      reg_data(1505)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(23).SC.MASTER.RX_RESET;
      ...
      reg_data(1509)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(23).SC.MASTER.IC.TX_WR;
      ...
      reg_data(1526)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(23).SC.MASTER.START_RESET;
      reg_data(1527)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(23).SC.MASTER.START_CONNECT;
      reg_data(1528)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(23).SC.MASTER.START_COMMAND;
      reg_data(1529)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(23).SC.MASTER.INJ_CRC_ERR;
      reg_data(1536)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(23).SC.SLAVE.TX_RESET;
      reg_data(1537)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(23).SC.SLAVE.RX_RESET;
      ...
      reg_data(1541)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(23).SC.SLAVE.IC.TX_WR;
      reg_data(1552)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(24).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(1557)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(24).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(1563)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(24).LPGBT.DOWNLINK.RESET;
      reg_data(1568)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(24).SC.MASTER.TX_RESET;
      reg_data(1569)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(24).SC.MASTER.RX_RESET;
      ...
      reg_data(1573)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(24).SC.MASTER.IC.TX_WR;
      ...
      reg_data(1590)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(24).SC.MASTER.START_RESET;
      reg_data(1591)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(24).SC.MASTER.START_CONNECT;
      reg_data(1592)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(24).SC.MASTER.START_COMMAND;
      reg_data(1593)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(24).SC.MASTER.INJ_CRC_ERR;
      reg_data(1600)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(24).SC.SLAVE.TX_RESET;
      reg_data(1601)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(24).SC.SLAVE.RX_RESET;
      ...
      reg_data(1605)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(24).SC.SLAVE.IC.TX_WR;
      reg_data(1616)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(25).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(1621)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(25).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(1627)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(25).LPGBT.DOWNLINK.RESET;
      reg_data(1632)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(25).SC.MASTER.TX_RESET;
      reg_data(1633)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(25).SC.MASTER.RX_RESET;
      ...
      reg_data(1637)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(25).SC.MASTER.IC.TX_WR;
      ...
      reg_data(1654)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(25).SC.MASTER.START_RESET;
      reg_data(1655)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(25).SC.MASTER.START_CONNECT;
      reg_data(1656)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(25).SC.MASTER.START_COMMAND;
      reg_data(1657)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(25).SC.MASTER.INJ_CRC_ERR;
      reg_data(1664)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(25).SC.SLAVE.TX_RESET;
      reg_data(1665)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(25).SC.SLAVE.RX_RESET;
      ...
      reg_data(1669)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(25).SC.SLAVE.IC.TX_WR;
      reg_data(1680)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(26).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(1685)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(26).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(1691)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(26).LPGBT.DOWNLINK.RESET;
      reg_data(1696)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(26).SC.MASTER.TX_RESET;
      reg_data(1697)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(26).SC.MASTER.RX_RESET;
      ...
      reg_data(1701)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(26).SC.MASTER.IC.TX_WR;
      ...
      reg_data(1718)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(26).SC.MASTER.START_RESET;
      reg_data(1719)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(26).SC.MASTER.START_CONNECT;
      reg_data(1720)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(26).SC.MASTER.START_COMMAND;
      reg_data(1721)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(26).SC.MASTER.INJ_CRC_ERR;
      reg_data(1728)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(26).SC.SLAVE.TX_RESET;
      reg_data(1729)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(26).SC.SLAVE.RX_RESET;
      ...
      reg_data(1733)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(26).SC.SLAVE.IC.TX_WR;
      reg_data(1744)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(27).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(1749)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(27).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(1755)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(27).LPGBT.DOWNLINK.RESET;
      reg_data(1760)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(27).SC.MASTER.TX_RESET;
      reg_data(1761)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(27).SC.MASTER.RX_RESET;
      ...
      reg_data(1765)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(27).SC.MASTER.IC.TX_WR;
      ...
      reg_data(1782)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(27).SC.MASTER.START_RESET;
      reg_data(1783)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(27).SC.MASTER.START_CONNECT;
      reg_data(1784)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(27).SC.MASTER.START_COMMAND;
      reg_data(1785)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(27).SC.MASTER.INJ_CRC_ERR;
      reg_data(1792)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(27).SC.SLAVE.TX_RESET;
      reg_data(1793)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(27).SC.SLAVE.RX_RESET;
      ...
      reg_data(1797)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(27).SC.SLAVE.IC.TX_WR;
      reg_data(1808)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(28).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(1813)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(28).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(1819)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(28).LPGBT.DOWNLINK.RESET;
      reg_data(1824)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(28).SC.MASTER.TX_RESET;
      reg_data(1825)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(28).SC.MASTER.RX_RESET;
      ...
      reg_data(1829)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(28).SC.MASTER.IC.TX_WR;
      ...
      reg_data(1846)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(28).SC.MASTER.START_RESET;
      reg_data(1847)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(28).SC.MASTER.START_CONNECT;
      reg_data(1848)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(28).SC.MASTER.START_COMMAND;
      reg_data(1849)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(28).SC.MASTER.INJ_CRC_ERR;
      reg_data(1856)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(28).SC.SLAVE.TX_RESET;
      reg_data(1857)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(28).SC.SLAVE.RX_RESET;
      ...
      reg_data(1861)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(28).SC.SLAVE.IC.TX_WR;
      reg_data(1872)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(29).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(1877)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(29).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(1883)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(29).LPGBT.DOWNLINK.RESET;
      reg_data(1888)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(29).SC.MASTER.TX_RESET;
      reg_data(1889)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(29).SC.MASTER.RX_RESET;
      ...
      reg_data(1893)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(29).SC.MASTER.IC.TX_WR;
      ...
      reg_data(1910)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(29).SC.MASTER.START_RESET;
      reg_data(1911)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(29).SC.MASTER.START_CONNECT;
      reg_data(1912)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(29).SC.MASTER.START_COMMAND;
      reg_data(1913)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(29).SC.MASTER.INJ_CRC_ERR;
      reg_data(1920)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(29).SC.SLAVE.TX_RESET;
      reg_data(1921)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(29).SC.SLAVE.RX_RESET;
      ...
      reg_data(1925)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(29).SC.SLAVE.IC.TX_WR;
      reg_data(1936)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(30).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(1941)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(30).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(1947)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(30).LPGBT.DOWNLINK.RESET;
      reg_data(1952)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(30).SC.MASTER.TX_RESET;
      reg_data(1953)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(30).SC.MASTER.RX_RESET;
      ...
      reg_data(1957)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(30).SC.MASTER.IC.TX_WR;
      ...
      reg_data(1974)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(30).SC.MASTER.START_RESET;
      reg_data(1975)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(30).SC.MASTER.START_CONNECT;
      reg_data(1976)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(30).SC.MASTER.START_COMMAND;
      reg_data(1977)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(30).SC.MASTER.INJ_CRC_ERR;
      reg_data(1984)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(30).SC.SLAVE.TX_RESET;
      reg_data(1985)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(30).SC.SLAVE.RX_RESET;
      ...
      reg_data(1989)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(30).SC.SLAVE.IC.TX_WR;
      reg_data(2000)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(31).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(2005)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(31).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(2011)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(31).LPGBT.DOWNLINK.RESET;
      reg_data(2016)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(31).SC.MASTER.TX_RESET;
      reg_data(2017)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(31).SC.MASTER.RX_RESET;
      ...
      reg_data(2021)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(31).SC.MASTER.IC.TX_WR;
      ...
      reg_data(2038)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(31).SC.MASTER.START_RESET;
      reg_data(2039)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(31).SC.MASTER.START_CONNECT;
      reg_data(2040)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(31).SC.MASTER.START_COMMAND;
      reg_data(2041)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(31).SC.MASTER.INJ_CRC_ERR;
      reg_data(2048)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(31).SC.SLAVE.TX_RESET;
      reg_data(2049)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(31).SC.SLAVE.RX_RESET;
      ...
      reg_data(2053)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(31).SC.SLAVE.IC.TX_WR;
      reg_data(2064)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(32).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(2069)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(32).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(2075)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(32).LPGBT.DOWNLINK.RESET;
      reg_data(2080)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(32).SC.MASTER.TX_RESET;
      reg_data(2081)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(32).SC.MASTER.RX_RESET;
      ...
      reg_data(2085)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(32).SC.MASTER.IC.TX_WR;
      ...
      reg_data(2102)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(32).SC.MASTER.START_RESET;
      reg_data(2103)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(32).SC.MASTER.START_CONNECT;
      reg_data(2104)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(32).SC.MASTER.START_COMMAND;
      reg_data(2105)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(32).SC.MASTER.INJ_CRC_ERR;
      reg_data(2112)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(32).SC.SLAVE.TX_RESET;
      reg_data(2113)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(32).SC.SLAVE.RX_RESET;
      ...
      reg_data(2117)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(32).SC.SLAVE.IC.TX_WR;
      reg_data(2128)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(33).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(2133)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(33).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(2139)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(33).LPGBT.DOWNLINK.RESET;
      reg_data(2144)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(33).SC.MASTER.TX_RESET;
      reg_data(2145)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(33).SC.MASTER.RX_RESET;
      ...
      reg_data(2149)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(33).SC.MASTER.IC.TX_WR;
      ...
      reg_data(2166)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(33).SC.MASTER.START_RESET;
      reg_data(2167)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(33).SC.MASTER.START_CONNECT;
      reg_data(2168)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(33).SC.MASTER.START_COMMAND;
      reg_data(2169)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(33).SC.MASTER.INJ_CRC_ERR;
      reg_data(2176)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(33).SC.SLAVE.TX_RESET;
      reg_data(2177)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(33).SC.SLAVE.RX_RESET;
      ...
      reg_data(2181)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(33).SC.SLAVE.IC.TX_WR;
      reg_data(2192)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(34).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(2197)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(34).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(2203)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(34).LPGBT.DOWNLINK.RESET;
      reg_data(2208)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(34).SC.MASTER.TX_RESET;
      reg_data(2209)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(34).SC.MASTER.RX_RESET;
      ...
      reg_data(2213)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(34).SC.MASTER.IC.TX_WR;
      ...
      reg_data(2230)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(34).SC.MASTER.START_RESET;
      reg_data(2231)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(34).SC.MASTER.START_CONNECT;
      reg_data(2232)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(34).SC.MASTER.START_COMMAND;
      reg_data(2233)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(34).SC.MASTER.INJ_CRC_ERR;
      reg_data(2240)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(34).SC.SLAVE.TX_RESET;
      reg_data(2241)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(34).SC.SLAVE.RX_RESET;
      ...
      reg_data(2245)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(34).SC.SLAVE.IC.TX_WR;
      reg_data(2256)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(35).LPGBT.UPLINK.UPLINK(0).RESET;
      reg_data(2261)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(35).LPGBT.UPLINK.UPLINK(1).RESET;
      reg_data(2267)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(35).LPGBT.DOWNLINK.RESET;
      reg_data(2272)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(35).SC.MASTER.TX_RESET;
      reg_data(2273)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(35).SC.MASTER.RX_RESET;
      ...
      reg_data(2277)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(35).SC.MASTER.IC.TX_WR;
      ...
      reg_data(2294)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(35).SC.MASTER.START_RESET;
      reg_data(2295)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(35).SC.MASTER.START_CONNECT;
      reg_data(2296)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(35).SC.MASTER.START_COMMAND;
      reg_data(2297)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(35).SC.MASTER.INJ_CRC_ERR;
      reg_data(2304)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(35).SC.SLAVE.TX_RESET;
      reg_data(2305)( 1)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(35).SC.SLAVE.RX_RESET;
      ...
      reg_data(2309)( 0)  <= DEFAULT_HAL_CTRL_t.CSM.CSM(35).SC.SLAVE.IC.TX_WR;
