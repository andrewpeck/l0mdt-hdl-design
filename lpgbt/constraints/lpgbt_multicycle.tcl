...
set from_sca [get_cells -of [all_fanout -endpoints_only -flat -from [get_nets top_hal/csm_gen[*]*/gbt_controller_wrapper_inst/valid]]]

if {[string is space $from_sca] == 0} {
    set_multicycle_path 8 -setup -from $from_sca
    set_multicycle_path 7 -hold -from $from_sca
}
