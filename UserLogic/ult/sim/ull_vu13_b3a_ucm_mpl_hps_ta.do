...
add wave -noupdate -expand -group ULT /ult_tp/ULT/h2s_ctrl_v
add wave -noupdate -expand -group ULT /ult_tp/ULT/tar_ctrl_v
add wave -noupdate -expand -group ULT /ult_tp/ULT/mtc_ctrl_v
add wave -noupdate -expand -group ULT /ult_tp/ULT/ucm_ctrl_v
add wave -noupdate -expand -group ULT /ult_tp/ULT/daq_ctrl_v
add wave -noupdate -expand -group ULT /ult_tp/ULT/tf_ctrl_v
add wave -noupdate -expand -group ULT /ult_tp/ULT/mpl_ctrl_v
...
add wave -noupdate -expand -group ULT -expand /ult_tp/ULT/pl2mtc_av
add wave -noupdate -expand -group ULT -expand /ult_tp/ULT/pt2mtc_av
add wave -noupdate -expand -group ULT /ult_tp/ULT/ucm_sump
add wave -noupdate -expand -group ULT /ult_tp/ULT/pt_sump
add wave -noupdate -expand -group ULT /ult_tp/ULT/h2s_sump
add wave -noupdate -expand -group ULT /ult_tp/ULT/tar_sump
add wave -noupdate -expand -group ULT /ult_tp/ULT/mtc_sump
add wave -noupdate -expand -group ULT /ult_tp/ULT/daq_sump
add wave -noupdate -expand -group ULT /ult_tp/ULT/mpl_sump
add wave -noupdate -expand -group ULT /ult_tp/ULT/h2s_mon_v
add wave -noupdate -expand -group ULT /ult_tp/ULT/tar_mon_v
add wave -noupdate -expand -group ULT /ult_tp/ULT/mtc_mon_v
add wave -noupdate -expand -group ULT /ult_tp/ULT/ucm_mon_v
add wave -noupdate -expand -group ULT /ult_tp/ULT/daq_mon_v
add wave -noupdate -expand -group ULT /ult_tp/ULT/tf_mon_v
add wave -noupdate -expand -group ULT /ult_tp/ULT/mpl_mon_v
...
WaveRestoreCursors {{Cursor 1} {32254902 fs} 0}
...
update
WaveRestoreZoom {0 fs} {92732843 fs}
