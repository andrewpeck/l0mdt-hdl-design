...
wire  signed [32:0] grp_fu_194_p2;
reg  signed [32:0] r_V_4_reg_248;
wire  signed [33:0] grp_fu_200_p3;
reg  signed [33:0] ret_V_reg_253;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_start == 1'b0) & (ap_start == 1'b1)) | ((roi_seed_r_V_1_ack_in == 1'b0) & (ap_enable_reg_pp0_iter7 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_start == 1'b0) & (ap_start == 1'b1)) | ((roi_seed_r_V_1_ack_in == 1'b0) & (ap_enable_reg_pp0_iter7 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_start == 1'b0) & (ap_start == 1'b1)) | ((roi_seed_r_V_1_ack_in == 1'b0) & (ap_enable_reg_pp0_iter7 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state8_pp0_stage0_iter7 = (roi_seed_r_V_1_ack_in == 1'b0);
end
...
assign ret_V_1_fu_174_p2 = ($signed(34'd17046700032) + $signed(ret_V_reg_253));
