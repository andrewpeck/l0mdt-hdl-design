...
reg  signed [17:0] hls_cos_val_V_read_reg_310;
wire   [17:0] r_0_V_fu_136_p2;
reg  signed [17:0] r_0_V_reg_315;
wire  signed [34:0] ret_V_1_fu_285_p2;
reg  signed [34:0] ret_V_1_reg_320;
wire   [20:0] trunc_ln1192_fu_150_p1;
reg   [20:0] trunc_ln1192_reg_325;
reg   [20:0] trunc_ln1192_reg_325_pp0_iter2_reg;
wire  signed [32:0] r_V_fu_291_p2;
reg  signed [32:0] r_V_reg_330;
wire   [16:0] trunc_ln851_fu_158_p1;
reg   [16:0] trunc_ln851_reg_337;
wire  signed [34:0] ret_V_fu_298_p2;
reg  signed [34:0] ret_V_reg_342;
reg   [17:0] z_fixed_int_shift_V_reg_347;
wire   [13:0] tmp_V_fu_220_p3;
reg   [13:0] tmp_V_reg_352;
reg   [17:0] z_2_V_reg_357;
reg   [17:0] z_2_V_reg_357_pp0_iter4_reg;
reg   [25:0] sin_inv_V_reg_367;
wire   [31:0] r_V_1_fu_304_p2;
reg   [31:0] r_V_1_reg_372;
reg    ap_block_pp0_stage0_subdone;
wire   [63:0] zext_ln544_fu_265_p1;
...
wire   [17:0] r_fixed_int_shift_V_fu_228_p4;
wire   [17:0] add_ln728_fu_237_p2;
wire   [20:0] lhs_V_fu_242_p3;
wire   [20:0] ret_V_2_fu_250_p2;
wire   [14:0] r_V_fu_291_p0;
wire   [25:0] r_V_1_fu_304_p0;
wire   [17:0] r_V_1_fu_304_p1;
reg   [0:0] ap_NS_fsm;
reg    ap_idle_pp0_0to6;
reg    ap_reset_idle_pp0;
wire    ap_enable_pp0;
wire   [31:0] r_V_1_fu_304_p00;
wire   [31:0] r_V_1_fu_304_p10;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        z_2_V_reg_357 <= {{ret_V_2_fu_250_p2[20:3]}};
        z_2_V_reg_357_pp0_iter4_reg <= z_2_V_reg_357;
        z_fixed_int_shift_V_reg_347 <= {{ret_V_1_reg_320[34:17]}};
    end
end
...
always @ (posedge ap_clk) begin
    if (((~((ap_start == 1'b0) & (ap_idle_pp0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) & (segpos_V_1_vld_reg == 1'b0) & (segpos_V_1_vld_in == 1'b1)) | (~((ap_start == 1'b0) & (ap_idle_pp0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) & (1'b1 == 1'b1) & (segpos_V_1_vld_in == 1'b1) & (segpos_V_1_vld_reg == 1'b1)))) begin
        segpos_V_1_data_reg <= {{r_V_1_reg_372[31:14]}};
    end
end
...
assign add_ln728_fu_237_p2 = (z_fixed_int_shift_V_reg_347 + r_fixed_int_shift_V_fu_228_p4);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_start == 1'b0) & (ap_start == 1'b1)) | ((segpos_V_1_ack_in == 1'b0) & (ap_enable_reg_pp0_iter7 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_start == 1'b0) & (ap_start == 1'b1)) | ((segpos_V_1_ack_in == 1'b0) & (ap_enable_reg_pp0_iter7 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_start == 1'b0) & (ap_start == 1'b1)) | ((segpos_V_1_ack_in == 1'b0) & (ap_enable_reg_pp0_iter7 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state8_pp0_stage0_iter7 = (segpos_V_1_ack_in == 1'b0);
end
...
assign icmp_ln851_fu_192_p2 = ((trunc_ln851_reg_337 == 17'd0) ? 1'b1 : 1'b0);

assign lhs_V_fu_242_p3 = {{add_ln728_fu_237_p2}, {3'd0}};

assign lut_divider_barrel_V_address0 = zext_ln544_fu_265_p1;

assign p_Result_s_fu_185_p3 = r_V_reg_330[32'd31];

assign r_0_V_fu_136_p2 = (slcvec_pos_R_V_0_data_reg - hewindow_pos_R_V_0_data_reg);

assign r_V_1_fu_304_p0 = r_V_1_fu_304_p00;

assign r_V_1_fu_304_p00 = sin_inv_V_reg_367;

assign r_V_1_fu_304_p1 = r_V_1_fu_304_p10;

assign r_V_1_fu_304_p10 = z_2_V_reg_357_pp0_iter4_reg;

assign r_V_fu_291_p0 = 33'd10083;

assign r_fixed_int_shift_V_fu_228_p4 = {{ret_V_reg_342[34:17]}};

assign ret_V_2_fu_250_p2 = (lhs_V_fu_242_p3 + trunc_ln1192_reg_325_pp0_iter2_reg);

assign ret_V_cast8_fu_176_p4 = {{r_V_reg_330[30:17]}};
...
assign tmp_1_fu_203_p4 = {{r_V_reg_330[30:17]}};
...
assign trunc_ln851_fu_158_p1 = r_V_fu_291_p2[16:0];

assign zext_ln544_fu_265_p1 = tmp_V_reg_352;
