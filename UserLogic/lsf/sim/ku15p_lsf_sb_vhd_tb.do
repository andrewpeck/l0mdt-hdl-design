...
vmap work lsf_lib
set CWD ./..
set IP_REPO ../../../l0mdt-hls/IPs/ku15p
...
#vlog -sv -work work +incdir+$CWD/../../dataformats/ "$SRC/compute_r_bins.sv"
#vlog -sv -work work +incdir+$CWD/../../dataformats/ "$SRC/get_rom_addr.sv"
