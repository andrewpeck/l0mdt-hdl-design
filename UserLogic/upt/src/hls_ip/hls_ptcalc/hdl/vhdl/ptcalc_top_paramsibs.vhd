...
entity ptcalc_top_paramsibs_rom is
    generic(
             DWIDTH     : integer := 19;
             AWIDTH     : integer := 7;
...
architecture rtl of ptcalc_top_paramsibs_rom is
...
entity ptcalc_top_paramsibs is
    generic (
...
architecture arch of ptcalc_top_paramsibs is
    component ptcalc_top_paramsibs_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    ptcalc_top_paramsibs_rom_U :  component ptcalc_top_paramsibs_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
