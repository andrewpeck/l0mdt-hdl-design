...
entity ptcalc_top_paramsg8j_rom is
    generic(
             DWIDTH     : integer := 24;
             AWIDTH     : integer := 6;
             MEM_SIZE    : integer := 60
...
architecture rtl of ptcalc_top_paramsg8j_rom is
...
entity ptcalc_top_paramsg8j is
    generic (
...
architecture arch of ptcalc_top_paramsg8j is
    component ptcalc_top_paramsg8j_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    ptcalc_top_paramsg8j_rom_U :  component ptcalc_top_paramsg8j_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
