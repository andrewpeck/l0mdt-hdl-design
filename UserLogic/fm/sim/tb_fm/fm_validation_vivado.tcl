...
proc checkRequiredFiles { origin_dir xilinx_tools_dir} {
  ...
  set files [list \
   ...
   "$origin_dir/../../../../Top/BoardTesting/l0mdt_ku15p_ull_fm/prj_cfg.vhd" \
...
set_property used_in_simulation false [get_files  $origin_dir/../../../../dataformats/l0mdt_buses_constants.svh]
...
if { [get_files prj_cfg.vhd] == "" } {
  import_files -quiet -fileset sources_1 $origin_dir/../../../../Top/BoardTesting/l0mdt_ku15p_ull_fm/prj_cfg.vhd
}
