...
set_instance_assignment -name USE_AS_3V_GPIO ON -to TEMP_MON_*

set_location_assignment PIN_AM38 -to TEMP_MON_SDA
set_location_assignment PIN_AM37 -to TEMP_MON_SCL 
