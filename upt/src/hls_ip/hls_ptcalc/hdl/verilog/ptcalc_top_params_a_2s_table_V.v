...
initial begin
    $readmemh("./ptcalc_top_params_a_2s_table_V_rom.dat", ram);
end
...
`timescale 1 ns / 1 ps
module ptcalc_top_params_a_2s_table_V(
    reset,
    clk,
    address0,
    ce0,
...
ptcalc_top_params_a_2s_table_V_rom ptcalc_top_params_a_2s_table_V_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ));
