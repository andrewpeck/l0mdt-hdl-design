...
entity ptcalc_top_rsp_table_V_rom is 
    generic(
             DWIDTH     : integer := 7; 
             AWIDTH     : integer := 12; 
...
architecture rtl of ptcalc_top_rsp_table_V_rom is 
...
entity ptcalc_top_rsp_table_V is
    generic (
        DataWidth : INTEGER := 7;
...
architecture arch of ptcalc_top_rsp_table_V is
    component ptcalc_top_rsp_table_V_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    ptcalc_top_rsp_table_V_rom_U :  component ptcalc_top_rsp_table_V_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
