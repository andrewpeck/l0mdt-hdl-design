...
`define AUTOTB_DUT      ptcalc_top
`define AUTOTB_DUT_INST AESL_inst_ptcalc_top
`define AUTOTB_TOP      apatb_ptcalc_top_top
`define AUTOTB_LAT_RESULT_FILE "ptcalc_top.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "ptcalc_top.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_ptcalc_top_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 1.55

`define AESL_DEPTH_pl2ptcalc_V 1
`define AESL_DEPTH_sf2ptcalc_inn_V 1
...
parameter AUTOTB_TRANSACTION_NUM = 4063;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 24;
parameter LENGTH_pl2ptcalc_V = 1;
parameter LENGTH_sf2ptcalc_inn_V = 1;
parameter LENGTH_sf2ptcalc_mid_V = 1;
parameter LENGTH_sf2ptcalc_out_V = 1;
parameter LENGTH_ptcalc2mtc_V = 1;
...
initial begin : read_file_process_pl2ptcalc_V
    ...
    transaction_idx = 0;
    wait(AESL_reset === 0);
    fp = $fopen(`AUTOTB_TVIN_pl2ptcalc_V,"r");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_pl2ptcalc_V);
    ...
    while (token != "[[[/runtime]]]") begin
        ...
        if(token != "[[/transaction]]") begin
            ret = $sscanf(token, "0x%x", AESL_REG_pl2ptcalc_V);
              if (ret != 1) begin
...
initial begin : read_file_process_sf2ptcalc_inn_V
    ...
    transaction_idx = 0;
    wait(AESL_reset === 0);
    fp = $fopen(`AUTOTB_TVIN_sf2ptcalc_inn_V,"r");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_sf2ptcalc_inn_V);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    read_token(fp, token);
    ...
    while (token != "[[[/runtime]]]") begin
        ...
        if(token != "[[/transaction]]") begin
            ret = $sscanf(token, "0x%x", AESL_REG_sf2ptcalc_inn_V);
              if (ret != 1) begin
                  $display("Failed to parse token!");
                $display("ERROR: Simulation using HLS TB failed.");
                  $finish;
...
initial begin : read_file_process_sf2ptcalc_mid_V
    ...
    transaction_idx = 0;
    wait(AESL_reset === 0);
    fp = $fopen(`AUTOTB_TVIN_sf2ptcalc_mid_V,"r");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_sf2ptcalc_mid_V);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    read_token(fp, token);
    ...
    while (token != "[[[/runtime]]]") begin
        ...
        if(token != "[[/transaction]]") begin
            ret = $sscanf(token, "0x%x", AESL_REG_sf2ptcalc_mid_V);
              if (ret != 1) begin
                  $display("Failed to parse token!");
                $display("ERROR: Simulation using HLS TB failed.");
                  $finish;
...
initial begin : read_file_process_sf2ptcalc_out_V
    ...
    transaction_idx = 0;
    wait(AESL_reset === 0);
    fp = $fopen(`AUTOTB_TVIN_sf2ptcalc_out_V,"r");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_sf2ptcalc_out_V);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    read_token(fp, token);
    ...
    while (token != "[[[/runtime]]]") begin
        ...
        if(token != "[[/transaction]]") begin
            ret = $sscanf(token, "0x%x", AESL_REG_sf2ptcalc_out_V);
              if (ret != 1) begin
                  $display("Failed to parse token!");
                $display("ERROR: Simulation using HLS TB failed.");
                  $finish;
...
reg AESL_REG_ptcalc2mtc_V_ap_vld = 0;
// The signal of port ptcalc2mtc_V
reg [53: 0] AESL_REG_ptcalc2mtc_V = 0;
...
initial begin : write_file_process_ptcalc2mtc_V
    ...
    integer proc_rand;
    integer ptcalc2mtc_V_count;
    reg [175:0] token;
    integer transaction_idx;
    reg [8 * 5:1] str;
    wait(AESL_reset === 0);
    fp = $fopen(`AUTOTB_TVOUT_ptcalc2mtc_V_out_wrapc,"w");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_ptcalc2mtc_V_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    while (transaction_idx != AUTOTB_TRANSACTION_NUM) begin
        ...
        if(AESL_REG_ptcalc2mtc_V_ap_vld)  begin
          $fdisplay(fp,"0x%x", AESL_REG_ptcalc2mtc_V);
        AESL_REG_ptcalc2mtc_V_ap_vld = 0;
        end
...
reg end_pl2ptcalc_V;
reg [31:0] size_pl2ptcalc_V;
reg [31:0] size_pl2ptcalc_V_backup;
reg end_sf2ptcalc_inn_V;
reg [31:0] size_sf2ptcalc_inn_V;
reg [31:0] size_sf2ptcalc_inn_V_backup;
reg end_sf2ptcalc_mid_V;
reg [31:0] size_sf2ptcalc_mid_V;
reg [31:0] size_sf2ptcalc_mid_V_backup;
reg end_sf2ptcalc_out_V;
reg [31:0] size_sf2ptcalc_out_V;
reg [31:0] size_sf2ptcalc_out_V_backup;
reg end_ptcalc2mtc_V;
reg [31:0] size_ptcalc2mtc_V;
reg [31:0] size_ptcalc2mtc_V_backup;
