...
#set CWD /home/psundara/L0MDT/psundara/HLS_MuTrig/
...
set GET_THETA_OFFSET_HLS_IP "$CWD/src/hls_ip/hls_get_theta_offset/hdl/verilog"
set GET_TRIG_ADDR_OFFSET_HLS_IP "$CWD/src/hls_ip/hls_get_trig_addr_offsets/hdl/verilog"
set COMPUTE_LE_RESULTS_HLS_IP "$CWD/hls_ip/src/hls_ComputeLegendreResults/hdl/verilog"
set HISTOGRAM_BIN_ACCUMULATION_HLS_IP "$CWD/src/hls_ip/hls_histogram_bin_accumulation/hdl/verilog"
set UPDATE_MAX_RBIN_HLS_IP "$CWD/src/hls_ip/hls_update_max_rbin/hdl/verilog"
set UPDATE_HISTOGRAM_HLS_IP "$CWD/src/hls_ip/hls_update_histogram/hdl/verilog"
...
set GET_LEGENDRE_SEGMENT_HLS_IP "$CWD/src/hls_ip/hls_get_legendre_segment_endcap/hdl/verilog"
set GET_LEGENDRE_SEGMENT_BARREL_HLS_IP "$CWD/src/hls_ip/hls_get_legendre_segment_barrel/hdl/verilog"
set CALC_LE_R_OFFSET_HLS_IP "$CWD/src/hls_ip/hls_calc_LE_r_offset/hdl/verilog"
set CALC_LE_R_OFFSET_BARREL_HLS_IP "$CWD/src/hls_ip/hls_calc_LE_r_offset_barrel/hdl/verilog"
set LOAD_LE_REFPOS "$CWD/src/hls_ip/hls_load_LE_refPos/hdl/verilog"
